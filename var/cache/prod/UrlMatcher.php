...
return [
        ...
        0 => '{^(?'
                ...
                .'|/sell/(?'
                    .'|c(?'
                        .'|atalog/(?'
                            .'|products(?'
                                ...
                                .'|\\-v2/(?'
                                    ...
                                    .'|(\\d+)/edit(*:3335)'
                                    .'|(\\d+)/shops(*:3355)'
                                    .'|virtual\\-product\\-file/(\\d+)(*:3392)'
                                    .'|(\\d+)/delete(*:3413)'
                                    .'|(\\d+)/duplicate(*:3437)'
                                    .'|(\\d+)/toggle_status(*:3465)'
                                    .'|search/(?'
                                        .'|([a-zA-Z]{2}(?:-[a-zA-Z]{2})?)(*:3514)'
                                        .'|combination/([a-zA-Z]{2}(?:-[a-zA-Z]{2})?)(*:3565)'
                                    .')'
                                .')'
                            .')'
                            .'|ca(?'
                                .'|t(?'
                                    .'|egories(?'
                                        ...
                                        .'|/(?'
                                            ...
                                            .'|(\\d+)/edit(*:3662)'
                                            .'|(\\d+)/edit\\-root(*:3687)'
                                            .'|(\\d+)/delete\\-cover\\-image(*:3722)'
                                            .'|(\\d+)/menu\\-thumbnails/(0|1|2)/delete(*:3768)'
                                        .')'
                                    .')'
                                    .'|alog\\-price\\-rules/(?'
                                        .'|(\\d+)/edit(*:3811)'
                            ...
                            .'|suppliers/(?'
                                ...
                                .'|(\\d+)/edit(*:3954)'
                                .'|(\\d+)/delete(*:3975)'
                                .'|(\\d+)/toggle\\-status(*:4004)'
                                .'|(\\d+)/delete\\-logo\\-image(*:4038)'
                            .')'
                            .'|brands/(?'
                                .'|(\\d+)/view(*:4068)'
                                .'|(\\d+)/edit(*:4087)'
                                .'|(\\d+)/delete(*:4108)'
                                .'|(\\d+)/toggle\\-status(*:4137)'
                                .'|(\\d+)/delete\\-logo\\-image(*:4171)'
                                .'|addresses/(?'
                                    .'|(\\d+)/edit(*:4203)'
                                    .'|(\\d+)/delete(*:4224)'
                                .')'
                            .')'
                            .'|features/(\\d+)/edit(*:4254)'
                            .'|attribute\\-groups/(?'
                                .'|(\\d+)/attributes(?'
                                    .'|(*:4303)'
                                .')'
                                .'|(\\d+)/attributes/new(*:4333)'
                                .'|(\\d+)/attributes/(\\d+)/edit(*:4369)'
                                .'|(\\d+)/attributes/([^/]++)/delete(*:4410)'
                                .'|(\\d+)/attributes/delete(*:4442)'
                                .'|(\\d+)/attributes/update\\-position(*:4484)'
                                .'|(\\d+)/view(*:4503)'
                                .'|(\\d+)/edit(*:4522)'
                                .'|(\\d+)/delete(*:4543)'
                            .')'
                        ...
                        .'|ustomer(?'
                            .'|s/(?'
                                .'|(\\d+)/edit(*:4579)'
                                .'|(\\d+)/view(*:4598)'
                                .'|(\\d+)/set\\-private\\-note(*:4631)'
                                .'|(\\d+)/toggle\\-status(*:4660)'
                                .'|([^/]++)/transform\\-guest\\-to\\-customer(*:4708)'
                                .'|(\\d+)/toggle\\-newsletter\\-subscription(*:4755)'
                                .'|(\\d+)/toggle\\-partner\\-offer\\-subscription(*:4806)'
                                .'|(\\d+)/carts(*:4826)'
                                .'|(\\d+)/orders(*:4847)'
                            .')'
                            .'|\\-service/(?'
                                ...
                                .'|customer\\-threads/(?'
                                    .'|(\\d+)/view(*:4961)'
                                    .'|(\\d+)/reply(*:4981)'
                                    .'|(\\d+)/update\\-status(*:5010)'
                                    .'|list/(\\d+)/update\\-status(*:5044)'
                                    .'|(\\d+)/forward(*:5066)'
                                    .'|(\\d+)/delete(*:5087)'
                                .')'
                            .')'
                    ...
                    .'|a(?'
                        .'|ddresses/(?'
                            .'|(\\d+)/edit(*:5126)'
                            .'|order/(\\d+)/(delivery|invoice)/edit(*:5170)'
                            .'|cart/(\\d+)/(delivery|invoice)/edit(*:5213)'
                            .'|(\\d+)/delete(*:5234)'
                        .')'
                        .'|ttachments/(?'
                            .'|(\\d+)/edit(*:5268)'
                    ...
                    .'|orders/(?'
                        ...
                        .'|carts/(?'
                            ...
                            .'|(\\d+)/currency(*:5511)'
                            .'|(\\d+)/language(*:5534)'
                            .'|(\\d+)/rules/delivery\\-settings(*:5573)'
                            .'|([^/]++)/cart\\-rules(?'
                                .'|(*:5605)'
                                .'|/([^/]++)/delete(*:5630)'
                            .')'
                            .'|(\\d+)/products(*:5654)'
                            .'|(\\d+)/products/(\\d+)/price(*:5689)'
                            .'|(\\d+)/products/(\\d+)/quantity(*:5727)'
                            .'|(\\d+)/delete\\-product(*:5757)'
                        .')'
                        .'|(\\d+)/generate\\-invoice\\-pdf(*:5795)'
                        .'|(\\d+)/generate\\-delivery\\-slip\\-pdf(*:5839)'
                        .'|(\\d+)/view(*:5858)'
                        .'|(\\d+)/cart\\-rules(*:5884)'
                        .'|list/(\\d+)/status(*:5910)'
                        .'|(\\d+)/status(*:5931)'
                        .'|(\\d+)/payment(*:5953)'
                        .'|(\\d+)/duplicate\\-cart(*:5983)'
                        .'|(\\d+)/currency/change(*:6013)'
                        .'|(\\d+)/products/(\\d+)(*:6042)'
                        .'|(\\d+)/cart\\-rules/(\\d+)/delete(*:6081)'
                        .'|(\\d+)/history/(\\d+)/statuses/(\\d+)/resend\\-email(*:6138)'
                        .'|(\\d+)/preview(*:6160)'
                        .'|(\\d+)/shipping(*:6183)'
                        .'|(\\d+)/invoice/(\\d+)/note(*:6216)'
                        .'|(\\d+)/invoice(*:6238)'
                        .'|([^/]++)/send\\-message(*:6269)'
                        .'|(\\d+)/partial\\-refund(*:6299)'
                        .'|(\\d+)/standard\\-refund(*:6330)'
                        .'|(\\d+)/return\\-product(*:6360)'
                        .'|(\\d+)/products(*:6383)'
                        .'|(\\d+)/products/(\\d+)/delete(*:6419)'
                        .'|(\\d+)/discounts(*:6443)'
                        .'|(\\d+)/prices(*:6464)'
                        .'|(\\d+)/payments(*:6487)'
                        .'|(\\d+)/products(*:6510)'
                        ...
                        .'|(\\d+)/shipping(*:6580)'
                        .'|(\\d+)/cancellation(*:6607)'
                        .'|display\\-customization\\-image/(\\d+)/(.+)(*:6656)'
                        .'|(\\d+)/products/prices(*:6686)'
                        .'|(\\d+)/set\\-internal\\-note(*:6720)'
                        .'|credit\\-slips/(\\d+)/pdf(*:6752)'
                    .')'
                .')'
                .'|/improve/(?'
                    .'|international/(?'
                        .'|languages/(?'
                            ...
                            .'|(\\d+)/delete(*:6836)'
                            .'|([^/]++)/toggle\\-status(*:6868)'
                            .'|bulk\\-toggle\\-status/(enable|disable)(*:6914)'
                        .')'
                        .'|c(?'
                            .'|urrencies/(?'
                                .'|(\\d+)/edit(*:6951)'
                                .'|(\\d+)/delete(*:6972)'
                                .'|(\\d+)/toggle\\-status(*:7001)'
                                .'|reference\\-data/([^/]++)(*:7034)'
                                .'|bulk\\-toggle\\-status/(enable|disable)(*:7080)'
                            .')'
                            .'|ountries/(\\d+)/edit(*:7109)'
                        .')'
                        .'|tax(?'
                            .'|es/(?'
                                .'|(\\d+)/edit(*:7141)'
                                .'|(\\d+)/delete(*:7162)'
                                .'|(\\d+)/toggle\\-status(*:7191)'
                            .')'
                            .'|_rules_groups/(?'
                                .'|(\\d+)/edit(*:7228)'
                                .'|(\\d+)/delete(*:7249)'
                                .'|(\\d+)/toggle\\-status(*:7278)'
                            .')'
                        .')'
                        .'|states/(?'
                            .'|(\\d+)/edit(*:7309)'
                        ...
                        .'|zones/(?'
                            .'|(\\d+)/edit(*:7391)'
                            .'|(\\d+)/delete(*:7412)'
                            .'|(\\d+)/toggle\\-status(*:7441)'
                            .'|bulk\\-toggle\\-status/(enable|disable)(*:7487)'
                        .')'
                    .')'
                    .'|modules/manage(?'
                        .'|(?:/([^/]++)(?:/([^/]++))?)?(*:7543)'
                        .'|/(?'
                            .'|action/(?'
                                .'|(install|uninstall|enable|disable|enableMobile|disableMobile|reset|upgrade)/([^/]++)(*:7650)'
                                .'|configure/([^/]++)(*:7677)'
                            .')'
                            .'|bulk/(install|uninstall|configure|enable|disable|reset|upgrade)(*:7750)'
                            .'|update/all(*:7769)'
                        .')'
                    .')'
                    .'|design/(?'
                        .'|themes/(?'
                            .'|([a-zA-Z0-9_.-]+)/enable(*:7824)'
                            .'|([a-zA-Z0-9_.-]+)/delete(*:7857)'
                            .'|([a-zA-Z0-9_.-]+)/reset\\-layouts(*:7898)'
                        .')'
                        .'|cms\\-pages/(?'
                            .'|(\\d+)/edit(*:7932)'
                            .'|(\\d+)/toggle\\-status(*:7961)'
                            .'|(\\d+)/delete(*:7982)'
                            .'|category/(?'
                                .'|(\\d+)/edit(*:8013)'
                                .'|(\\d+)/delete(*:8034)'
                                .'|(\\d+)/toggle\\-status(*:8063)'
                            .')'
                        .')'
                        .'|mail_theme/(?'
                            .'|send(?'
                    ...
                    .'|shipping/carriers/(?'
                        .'|(\\d+)/edit(*:8468)'
                        .'|(\\d+)/delete(*:8489)'
                        .'|(\\d+)/toggle\\-status(*:8518)'
                        .'|(\\d+)/toggle\\-is\\-free(*:8549)'
                    .')'
                .')'
                .'|/api/(?'
                    .'|stock(?'
                        .'|s/(?'
                            ...
                            .'|product/(?'
                                .'|(\\d+)(*:8611)'
                                .'|(\\d+)/combination/(\\d+)(*:8643)'
                            .')'
                        .')'
                        .'|\\-movements/product/(\\d+)(*:8679)'
                    .')'
                    .'|i18n/(\\w+)(*:8699)'
                    .'|translations/(?'
                        .'|tree/([^/]++)/([^/]++)(?:/([^/]++))?(*:8760)'
    ...
    [ // $dynamicRoutes
        ...
        3355 => [[['_route' => 'admin_products_select_shops', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Catalog\\Product\\ProductController::selectProductShopsAction', '_legacy_controller' => 'AdminProducts', '_legacy_link' => ['AdminProducts:assignshops'], '_legacy_parameters' => ['id_product' => 'productId']], ['productId'], ['GET' => 0, 'POST' => 1, 'PATCH' => 2], null, false, false, null]],
        3392 => [[['_route' => 'admin_products_v2_download_virtual_product_file', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Catalog\\Product\\ProductController::downloadVirtualFileAction', '_legacy_controller' => 'AdminProducts'], ['virtualProductFileId'], ['GET' => 0], null, false, true, null]],
        3413 => [[['_route' => 'admin_products_v2_delete', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Catalog\\Product\\ProductController::deleteAction', '_legacy_controller' => 'AdminProducts', '_legacy_link' => ['AdminProducts:delete'], '_legacy_parameters' => ['id_product' => 'productId']], ['productId'], ['POST' => 0, 'DELETE' => 1], null, false, false, null]],
        3437 => [[['_route' => 'admin_products_v2_duplicate', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Catalog\\Product\\ProductController::duplicateAction', '_legacy_controller' => 'AdminProducts', '_legacy_link' => ['AdminProducts:duplicate'], '_legacy_parameters' => ['id_product' => 'productId']], ['productId'], ['POST' => 0], null, false, false, null]],
        3465 => [[['_route' => 'admin_products_v2_toggle_status', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Catalog\\Product\\ProductController::toggleStatusAction', '_legacy_controller' => 'AdminProducts', '_legacy_link' => ['AdminProducts:statusproduct'], '_legacy_parameters' => ['id_product' => 'productId']], ['productId'], ['POST' => 0], null, false, false, null]],
        3514 => [[['_route' => 'admin_products_v2_search_associations', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Catalog\\Product\\ProductController::searchAssociationsAction', '_legacy_controller' => 'AdminProducts'], ['languageCode'], ['GET' => 0, 'POST' => 1], null, false, true, null]],
        3565 => [[['_route' => 'admin_products_v2_search_combinations', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Catalog\\Product\\CombinationController::searchCombinationProductsAction', '_legacy_controller' => 'AdminProducts'], ['languageCode'], ['GET' => 0, 'POST' => 1], null, false, true, null]],
        3607 => [[['_route' => 'admin_categories_index', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Catalog\\CategoryController::indexAction', '_legacy_controller' => 'AdminCategories', '_legacy_link' => 'AdminCategories', '_legacy_parameters' => ['id_category' => 'categoryId'], 'categoryId' => null], ['categoryId'], ['GET' => 0, 'POST' => 1], null, false, true, null]],
        3643 => [[['_route' => 'admin_categories_toggle_status', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Catalog\\CategoryController::toggleStatusAction', '_legacy_controller' => 'AdminCategories', '_legacy_link' => 'AdminCategories:statuscategory', '_legacy_parameters' => ['id_category' => 'categoryId']], ['categoryId'], ['POST' => 0], null, false, false, null]],
        3662 => [[['_route' => 'admin_categories_edit', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Catalog\\CategoryController::editAction', '_legacy_controller' => 'AdminCategories', '_legacy_link' => 'AdminCategories:updatecategory', '_legacy_parameters' => ['id_category' => 'categoryId']], ['categoryId'], ['GET' => 0, 'POST' => 1], null, false, false, null]],
        3687 => [[['_route' => 'admin_categories_edit_root', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Catalog\\CategoryController::editRootAction', '_legacy_controller' => 'AdminCategories', '_legacy_link' => 'AdminCategories:updatecategory', '_legacy_parameters' => ['id_category' => 'categoryId']], ['categoryId'], ['GET' => 0, 'POST' => 1], null, false, false, null]],
        3722 => [[['_route' => 'admin_categories_delete_cover_image', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Catalog\\CategoryController::deleteCoverImageAction', '_legacy_controller' => 'AdminCategories', '_legacy_link' => 'AdminCategories:deleteImage', '_legacy_parameters' => ['id_category' => 'categoryId']], ['categoryId'], ['POST' => 0], null, false, false, null]],
        3768 => [[['_route' => 'admin_categories_delete_menu_thumbnail', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Catalog\\CategoryController::deleteMenuThumbnailAction', '_legacy_controller' => 'AdminCategories', '_legacy_link' => 'AdminCategories:forceDeleteThumb', '_legacy_parameters' => ['id_category' => 'categoryId']], ['categoryId', 'menuThumbnailId'], ['POST' => 0], null, false, false, null]],
        3811 => [[['_route' => 'admin_catalog_price_rules_edit', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Catalog\\CatalogPriceRuleController::editAction', '_legacy_controller' => 'AdminSpecificPriceRule', '_legacy_parameters' => ['id_specific_price_rule' => 'catalogPriceRuleId']], ['catalogPriceRuleId'], ['GET' => 0, 'POST' => 1], null, false, false, null]],
        3832 => [[['_route' => 'admin_catalog_price_rules_delete', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Catalog\\CatalogPriceRuleController::deleteAction', '_legacy_controller' => 'AdminSpecificPriceRule', '_legacy_parameters' => ['id_specific_price_rule' => 'catalogPriceRuleId']], ['catalogPriceRuleId'], ['POST' => 0], null, false, false, null]],
        3876 => [[['_route' => 'admin_cart_rule_toggle_status', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Catalog\\CartRuleController::toggleStatusAction', '_legacy_controller' => 'AdminCartRules', '_legacy_parameters' => ['id_cart_rule' => 'cartRuleId']], ['cartRuleId'], ['POST' => 0], null, false, false, null]],
        3897 => [[['_route' => 'admin_cart_rules_delete', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Catalog\\CartRuleController::deleteAction', '_legacy_controller' => 'AdminCartRules', '_legacy_parameters' => ['id_cart_rule' => 'cartRuleId']], ['cartRuleId'], ['POST' => 0, 'DELETE' => 1], null, false, false, null]],
        3935 => [[['_route' => 'admin_suppliers_view', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Catalog\\SupplierController::viewAction', '_legacy_controller' => 'AdminSuppliers', '_legacy_link' => 'AdminSuppliers:viewsupplier', '_legacy_parameters' => ['id_supplier' => 'supplierId']], ['supplierId'], ['GET' => 0], null, false, false, null]],
        3954 => [[['_route' => 'admin_suppliers_edit', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Catalog\\SupplierController::editAction', '_legacy_controller' => 'AdminSuppliers', '_legacy_link' => 'AdminSuppliers:updatesupplier', '_legacy_parameters' => ['id_supplier' => 'supplierId']], ['supplierId'], ['GET' => 0, 'POST' => 1], null, false, false, null]],
        3975 => [[['_route' => 'admin_suppliers_delete', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Catalog\\SupplierController::deleteAction', '_legacy_controller' => 'AdminSuppliers', '_legacy_link' => 'AdminSuppliers:deletesupplier', '_legacy_parameters' => ['id_supplier' => 'supplierId']], ['supplierId'], ['DELETE' => 0], null, false, false, null]],
        4004 => [[['_route' => 'admin_suppliers_toggle_status', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Catalog\\SupplierController::toggleStatusAction', '_legacy_controller' => 'AdminSuppliers', '_legacy_link' => 'AdminSuppliers:statussupplier', '_legacy_parameters' => ['id_supplier' => 'supplierId']], ['supplierId'], ['POST' => 0], null, false, false, null]],
        4038 => [[['_route' => 'admin_suppliers_delete_logo_image', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Catalog\\SupplierController::deleteLogoImageAction', '_legacy_controller' => 'AdminSuppliers', '_legacy_link' => 'AdminSuppliers:deleteImage', '_legacy_parameters' => ['id_supplier' => 'supplierId']], ['supplierId'], ['GET' => 0, 'POST' => 1], null, false, false, null]],
        4068 => [[['_route' => 'admin_manufacturers_view', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Catalog\\ManufacturerController::viewAction', '_legacy_controller' => 'AdminManufacturers', '_legacy_link' => 'AdminManufacturers:viewmanufacturer', '_legacy_parameters' => ['id_manufacturer' => 'manufacturerId']], ['manufacturerId'], ['GET' => 0], null, false, false, null]],
        4087 => [[['_route' => 'admin_manufacturers_edit', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Catalog\\ManufacturerController::editAction', '_legacy_controller' => 'AdminManufacturers', '_legacy_link' => 'AdminManufacturers:updatemanufacturer', '_legacy_parameters' => ['id_manufacturer' => 'manufacturerId']], ['manufacturerId'], ['GET' => 0, 'POST' => 1], null, false, false, null]],
        4108 => [[['_route' => 'admin_manufacturers_delete', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Catalog\\ManufacturerController::deleteAction', '_legacy_controller' => 'AdminManufacturers', '_legacy_link' => 'AdminManufacturers:deletemanufacturer', '_legacy_parameters' => ['id_manufacturer' => 'manufacturerId']], ['manufacturerId'], ['POST' => 0, 'DELETE' => 1], null, false, false, null]],
        4137 => [[['_route' => 'admin_manufacturers_toggle_status', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Catalog\\ManufacturerController::toggleStatusAction', '_legacy_controller' => 'AdminManufacturers', '_legacy_link' => 'AdminManufacturers:statusmanufacturer', '_legacy_parameters' => ['id_manufacturer' => 'manufacturerId']], ['manufacturerId'], ['POST' => 0], null, false, false, null]],
        4171 => [[['_route' => 'admin_manufacturers_delete_logo_image', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Catalog\\ManufacturerController::deleteLogoImageAction', '_legacy_controller' => 'AdminManufacturers', '_legacy_link' => 'AdminManufacturers:deleteImage', '_legacy_parameters' => ['id_manufacturer' => 'manufacturerId']], ['manufacturerId'], ['GET' => 0, 'POST' => 1], null, false, false, null]],
        4203 => [[['_route' => 'admin_manufacturer_addresses_edit', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Catalog\\ManufacturerController::editAddressAction', '_legacy_controller' => 'AdminManufacturers', '_legacy_link' => 'AdminManufacturers:editaddresses', '_legacy_parameters' => ['id_address' => 'addressId']], ['addressId'], ['GET' => 0, 'POST' => 1], null, false, false, null]],
        4224 => [[['_route' => 'admin_manufacturer_addresses_delete', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Catalog\\ManufacturerController::deleteAddressAction', '_legacy_controller' => 'AdminManufacturers', '_legacy_link' => 'AdminManufacturers:deleteaddress', '_legacy_parameters' => ['id_address' => 'addressId']], ['addressId'], ['POST' => 0, 'DELETE' => 1], null, false, false, null]],
        4254 => [[['_route' => 'admin_features_edit', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Catalog\\FeatureController::editAction', '_legacy_controller' => 'AdminFeatures', '_legacy_link' => 'AdminFeatures:updatefeature', '_legacy_parameters' => ['id_feature' => 'featureId']], ['featureId'], ['GET' => 0, 'POST' => 1], null, false, false, null]],
        4303 => [
        ...
        4333 => [[['_route' => 'admin_attributes_create', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Catalog\\AttributeController::createAction', '_legacy_controller' => 'AdminAttributesGroups', 'redirectQueryParamsToKeep' => ['attributeGroupId']], ['attributeGroupId'], ['GET' => 0, 'POST' => 1], null, false, false, null]],
        4369 => [[['_route' => 'admin_attributes_edit', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Catalog\\AttributeController::editAction', '_legacy_controller' => 'AdminAttributesGroups', 'redirectQueryParamsToKeep' => ['attributeGroupId'], '_legacy_parameters' => ['id_attribute_group' => 'attributeGroupId', 'id_attribute' => 'attributeId']], ['attributeGroupId', 'attributeId'], ['GET' => 0, 'POST' => 1], null, false, false, null]],
        4410 => [[['_route' => 'admin_attributes_delete', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Catalog\\AttributeController::deleteAction', '_legacy_controller' => 'AdminAttributesGroups', 'redirectQueryParamsToKeep' => ['attributeGroupId'], '_legacy_parameters' => ['id_attribute_group' => 'attributeGroupId', 'id_attribute' => 'attributeId']], ['attributeGroupId', 'attributeId'], ['POST' => 0, 'DELETE' => 1], null, false, false, null]],
        4442 => [[['_route' => 'admin_attributes_bulk_delete', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Catalog\\AttributeController::bulkDeleteAction', '_legacy_controller' => 'AdminAttributesGroups', 'redirectQueryParamsToKeep' => ['attributeGroupId'], '_legacy_parameters' => ['id_attribute_group' => 'attributeGroupId', 'id_attribute' => 'attributeId']], ['attributeGroupId'], ['POST' => 0], null, false, false, null]],
        4484 => [[['_route' => 'admin_attributes_update_position', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Catalog\\AttributeController::updatePositionAction', '_legacy_controller' => 'AdminAttributesGroups'], ['attributeGroupId'], ['POST' => 0], null, false, false, null]],
        4503 => [[['_route' => 'admin_attribute_groups_view', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Catalog\\AttributeController::indexAction', '_legacy_controller' => 'AdminAttributesGroups', '_legacy_link' => 'AdminAttributesGroups:viewattribute_group', '_legacy_feature_flag' => 'attribute_group', '_legacy_parameters' => ['id_attribute_group' => 'attributeGroupId']], ['attributeGroupId'], ['GET' => 0], null, false, false, null]],
        4522 => [[['_route' => 'admin_attribute_groups_edit', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Catalog\\AttributeGroupController::editAction', '_legacy_controller' => 'AdminAttributesGroups', '_legacy_link' => 'AdminAttributesGroups:updateattribute_group', '_legacy_feature_flag' => 'attribute_group', '_legacy_parameters' => ['id_attribute_group' => 'attributeGroupId']], ['attributeGroupId'], ['GET' => 0, 'POST' => 1], null, false, false, null]],
        4543 => [[['_route' => 'admin_attribute_groups_delete', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Catalog\\AttributeGroupController::deleteAction', '_legacy_controller' => 'AdminAttributesGroups', '_legacy_feature_flag' => 'attribute_group', '_legacy_link' => 'AdminAttributesGroups:deleteattribute_group', '_legacy_parameters' => ['id_attribute_group' => 'attributeGroupId']], ['attributeGroupId'], ['POST' => 0, 'DELETE' => 1], null, false, false, null]],
        4579 => [[['_route' => 'admin_customers_edit', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Customer\\CustomerController::editAction', '_legacy_controller' => 'AdminCustomers', '_legacy_link' => 'AdminCustomers:updatecustomer', '_legacy_parameters' => ['id_customer' => 'customerId']], ['customerId'], ['GET' => 0, 'POST' => 1], null, false, false, null]],
        4598 => [[['_route' => 'admin_customers_view', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Customer\\CustomerController::viewAction', '_legacy_controller' => 'AdminCustomers', '_legacy_link' => 'AdminCustomers:viewcustomer', '_legacy_parameters' => ['id_customer' => 'customerId']], ['customerId'], ['GET' => 0, 'POST' => 1], null, false, false, null]],
        4631 => [[['_route' => 'admin_customers_set_private_note', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Customer\\CustomerController::setPrivateNoteAction', '_legacy_controller' => 'AdminCustomers', '_legacy_link' => 'AdminCustomers:updateCustomerNote', '_legacy_parameters' => ['id_customer' => 'customerId']], ['customerId'], ['POST' => 0], null, false, false, null]],
        4660 => [[['_route' => 'admin_customers_toggle_status', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Customer\\CustomerController::toggleStatusAction', '_legacy_controller' => 'AdminCustomers', '_legacy_link' => 'AdminCustomers:statuscustomer', '_legacy_parameters' => ['id_customer' => 'customerId']], ['customerId'], ['POST' => 0], null, false, false, null]],
        4708 => [[['_route' => 'admin_customers_transform_guest_to_customer', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Customer\\CustomerController::transformGuestToCustomerAction', '_legacy_controller' => 'AdminCustomers', '_legacy_link' => 'AdminCustomers:guesttocustomer', '_legacy_parameters' => ['id_customer' => 'customerId']], ['customerId'], ['POST' => 0], null, false, false, null]],
        4755 => [[['_route' => 'admin_customers_toggle_newsletter_subscription', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Customer\\CustomerController::toggleNewsletterSubscriptionAction', '_legacy_controller' => 'AdminCustomers', '_legacy_link' => 'AdminCustomers:changeNewsletterVal', '_legacy_parameters' => ['id_customer' => 'customerId']], ['customerId'], ['POST' => 0], null, false, false, null]],
        4806 => [[['_route' => 'admin_customers_toggle_partner_offer_subscription', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Customer\\CustomerController::togglePartnerOfferSubscriptionAction', '_legacy_controller' => 'AdminCustomers', '_legacy_link' => 'AdminCustomers:changeOptinVal', '_legacy_parameters' => ['id_customer' => 'customerId']], ['customerId'], ['POST' => 0], null, false, false, null]],
        4826 => [[['_route' => 'admin_customers_carts', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Customer\\CustomerController::getCartsAction', '_legacy_controller' => 'AdminCustomers', '_legacy_link' => 'AdminCustomers'], ['customerId'], ['GET' => 0], null, false, false, null]],
        4847 => [[['_route' => 'admin_customers_orders', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Customer\\CustomerController::getOrdersAction', '_legacy_controller' => 'AdminCustomers', '_legacy_link' => 'AdminCustomers'], ['customerId'], ['GET' => 0], null, false, false, null]],
        4899 => [[['_route' => 'admin_order_messages_edit', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\CustomerService\\OrderMessageController::editAction', '_legacy_controller' => 'AdminOrderMessage', '_legacy_link' => 'AdminOrderMessage:updateorder_message', 'legacy_parameters' => ['id_order_message' => 'orderMessageId']], ['orderMessageId'], ['GET' => 0, 'POST' => 1], null, false, false, null]],
        4920 => [[['_route' => 'admin_order_messages_delete', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\CustomerService\\OrderMessageController::deleteAction', '_legacy_controller' => 'AdminOrderMessage', '_legacy_link' => 'AdminOrderMessage:deleteorder_message', 'legacy_parameters' => ['id_order_message' => 'orderMessageId']], ['orderMessageId'], ['POST' => 0], null, false, false, null]],
        4961 => [[['_route' => 'admin_customer_threads_view', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\CustomerService\\CustomerThreadController::viewAction', '_legacy_controller' => 'AdminCustomerThreads', '_legacy_parameters' => ['id_customer_thread' => 'customerThreadId'], '_legacy_link' => 'AdminCustomerThreads:viewcustomer_thread'], ['customerThreadId'], ['GET' => 0], null, false, false, null]],
        4981 => [[['_route' => 'admin_customer_threads_reply', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\CustomerService\\CustomerThreadController::replyAction', '_legacy_controller' => 'AdminCustomerThreads'], ['customerThreadId'], ['POST' => 0], null, false, false, null]],
        5010 => [[['_route' => 'admin_customer_threads_view_update_status', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\CustomerService\\CustomerThreadController::updateStatusFromViewAction', '_legacy_controller' => 'AdminCustomerThreads'], ['customerThreadId'], ['POST' => 0], null, false, false, null]],
        5044 => [[['_route' => 'admin_customer_threads_list_update_status', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\CustomerService\\CustomerThreadController::updateStatusFromListAction', '_legacy_controller' => 'AdminCustomerThreads'], ['customerThreadId'], ['POST' => 0], null, false, false, null]],
        5066 => [[['_route' => 'admin_customer_threads_forward', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\CustomerService\\CustomerThreadController::forwardAction', '_legacy_controller' => 'AdminCustomerThreads'], ['customerThreadId'], ['POST' => 0], null, false, false, null]],
        5087 => [[['_route' => 'admin_customer_threads_delete', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\CustomerService\\CustomerThreadController::deleteAction', '_legacy_controller' => 'AdminCustomerThreads'], ['customerThreadId'], ['POST' => 0, 'DELETE' => 1], null, false, false, null]],
        5126 => [[['_route' => 'admin_addresses_edit', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Address\\AddressController::editAction', '_legacy_controller' => 'AdminAddresses', '_legacy_link' => 'AdminAddresses:updateaddress', '_legacy_parameters' => ['id_address' => 'addressId']], ['addressId'], ['GET' => 0, 'POST' => 1], null, false, false, null]],
        5170 => [[['_route' => 'admin_order_addresses_edit', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Address\\AddressController::editOrderAddressAction', '_legacy_controller' => 'AdminAddresses'], ['orderId', 'addressType'], ['GET' => 0, 'POST' => 1], null, false, false, null]],
        5213 => [[['_route' => 'admin_cart_addresses_edit', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Address\\AddressController::editCartAddressAction', '_legacy_controller' => 'AdminAddresses'], ['cartId', 'addressType'], ['GET' => 0, 'POST' => 1], null, false, false, null]],
        5234 => [[['_route' => 'admin_addresses_delete', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Address\\AddressController::deleteAction', '_legacy_controller' => 'AdminAddresses', '_legacy_link' => 'AdminAddresses:deleteaddress', '_legacy_parameters' => ['id_address' => 'addressId']], ['addressId'], ['POST' => 0, 'DELETE' => 1], null, false, false, null]],
        5268 => [[['_route' => 'admin_attachments_edit', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Catalog\\AttachmentController::editAction', '_legacy_controller' => 'AdminAttachments', '_legacy_link' => 'AdminAttachments:updateattachment', '_legacy_parameters' => ['id_attachment' => 'attachmentId']], ['attachmentId'], ['GET' => 0, 'POST' => 1], null, false, false, null]],
        5287 => [[['_route' => 'admin_attachments_view', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Catalog\\AttachmentController::viewAction', '_legacy_controller' => 'AdminAttachments', '_legacy_link' => 'AdminAttachments:viewattachment', '_legacy_parameters' => ['id_attachment' => 'attachmentId']], ['attachmentId'], ['GET' => 0, 'POST' => 1], null, false, false, null]],
        5308 => [[['_route' => 'admin_attachments_delete', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Catalog\\AttachmentController::deleteAction', '_legacy_controller' => 'AdminAttachments', '_legacy_link' => 'AdminAttachments:deleteattachment', '_legacy_parameters' => ['id_attachment' => 'attachmentId']], ['attachmentId'], ['POST' => 0], null, false, false, null]],
        5327 => [[['_route' => 'admin_attachments_attachment_info', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Catalog\\AttachmentController::getAttachmentInfoAction'], ['attachmentId'], ['GET' => 0], null, false, false, null]],
        5351 => [[['_route' => 'admin_attachments_search', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Catalog\\AttachmentController::searchAction', '_legacy_controller' => 'AdminAttachments', '_legacy_link' => 'AdminAttachments:search'], ['searchPhrase'], ['GET' => 0], null, false, true, null]],
        5395 => [[['_route' => 'admin_order_invoices_generate_by_id', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Order\\InvoicesController::generatePdfByIdAction', '_legacy_controller' => 'AdminInvoices'], ['invoiceId'], ['GET' => 0], null, false, false, null]],
        5423 => [[['_route' => 'admin_carts_view', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Order\\CartController::viewAction', '_legacy_controller' => 'AdminCarts', '_legacy_link' => 'AdminCarts:viewcart', '_legacy_parameters' => ['id_cart' => 'cartId']], ['cartId'], ['GET' => 0], null, false, false, null]],
        5442 => [[['_route' => 'admin_carts_info', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Order\\CartController::getInfoAction', '_legacy_controller' => 'AdminCarts'], ['cartId'], ['GET' => 0], null, false, false, null]],
        5466 => [[['_route' => 'admin_carts_edit_addresses', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Order\\CartController::editAddressesAction', '_legacy_controller' => 'AdminCarts'], ['cartId'], ['POST' => 0], null, false, false, null]],
        5488 => [[['_route' => 'admin_carts_edit_carrier', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Order\\CartController::editCarrierAction', '_legacy_controller' => 'AdminCarts'], ['cartId'], ['POST' => 0], null, false, false, null]],
        5511 => [[['_route' => 'admin_carts_edit_currency', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Order\\CartController::editCurrencyAction', '_legacy_controller' => 'AdminCarts'], ['cartId'], ['POST' => 0], null, false, false, null]],
        5534 => [[['_route' => 'admin_carts_edit_language', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Order\\CartController::editLanguageAction', '_legacy_controller' => 'AdminCarts'], ['cartId'], ['POST' => 0], null, false, false, null]],
        5573 => [[['_route' => 'admin_carts_set_delivery_settings', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Order\\CartController::updateDeliverySettingsAction', '_legacy_controller' => 'AdminCarts'], ['cartId'], ['POST' => 0], null, false, false, null]],
        5605 => [[['_route' => 'admin_carts_add_cart_rule', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Order\\CartController::addCartRuleAction', '_legacy_controller' => 'AdminCarts'], ['cartId'], ['POST' => 0], null, false, false, null]],
        5630 => [[['_route' => 'admin_carts_delete_cart_rule', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Order\\CartController::deleteCartRuleAction', '_legacy_controller' => 'AdminCarts'], ['cartId', 'cartRuleId'], ['POST' => 0], null, false, false, null]],
        5654 => [[['_route' => 'admin_carts_add_product', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Order\\CartController::addProductAction', '_legacy_controller' => 'AdminCarts'], ['cartId'], ['POST' => 0], null, false, false, null]],
        5689 => [[['_route' => 'admin_carts_edit_product_price', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Order\\CartController::editProductPriceAction', '_legacy_controller' => 'AdminCarts'], ['cartId', 'productId'], ['POST' => 0], null, false, false, null]],
        5727 => [[['_route' => 'admin_carts_edit_product_quantity', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Order\\CartController::editProductQuantityAction', '_legacy_controller' => 'AdminCarts'], ['cartId', 'productId'], ['POST' => 0], null, false, false, null]],
        5757 => [[['_route' => 'admin_carts_delete_product', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Order\\CartController::deleteProductAction', '_legacy_controller' => 'AdminCarts'], ['cartId'], ['POST' => 0], null, false, false, null]],
        5795 => [[['_route' => 'admin_orders_generate_invoice_pdf', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Order\\OrderController::generateInvoicePdfAction', '_legacy_controller' => 'AdminOrders'], ['orderId'], ['GET' => 0], null, false, false, null]],
        5839 => [[['_route' => 'admin_orders_generate_delivery_slip_pdf', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Order\\OrderController::generateDeliverySlipPdfAction', '_legacy_controller' => 'AdminOrders'], ['orderId'], ['GET' => 0], null, false, false, null]],
        5858 => [[['_route' => 'admin_orders_view', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Order\\OrderController::viewAction', '_legacy_controller' => 'AdminOrders', '_legacy_link' => 'AdminOrders:vieworder', '_legacy_parameters' => ['id_order' => 'orderId']], ['orderId'], ['GET' => 0, 'POST' => 1], null, false, false, null]],
        5884 => [[['_route' => 'admin_orders_add_cart_rule', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Order\\OrderController::addCartRuleAction'], ['orderId'], ['POST' => 0], null, false, false, null]],
        5910 => [[['_route' => 'admin_orders_list_update_status', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Order\\OrderController::updateStatusFromListAction', '_legacy_controller' => 'AdminOrders'], ['orderId'], ['POST' => 0], null, false, false, null]],
        5931 => [[['_route' => 'admin_orders_update_status', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Order\\OrderController::updateStatusAction', '_legacy_controller' => 'AdminOrders'], ['orderId'], ['POST' => 0], null, false, false, null]],
        5953 => [[['_route' => 'admin_orders_add_payment', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Order\\OrderController::addPaymentAction'], ['orderId'], ['POST' => 0], null, false, false, null]],
        5983 => [[['_route' => 'admin_orders_duplicate_cart', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Order\\OrderController::duplicateOrderCartAction', '_legacy_controller' => 'AdminOrders'], ['orderId'], ['POST' => 0], null, false, false, null]],
        6013 => [[['_route' => 'admin_orders_change_currency', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Order\\OrderController::changeCurrencyAction', '_legacy_controller' => 'AdminOrders'], ['orderId'], ['POST' => 0], null, false, false, null]],
        6042 => [[['_route' => 'admin_orders_update_product', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Order\\OrderController::updateProductAction', '_legacy_controller' => 'AdminOrders'], ['orderId', 'orderDetailId'], ['POST' => 0], null, false, true, null]],
        6081 => [[['_route' => 'admin_orders_remove_cart_rule', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Order\\OrderController::removeCartRuleAction'], ['orderId', 'orderCartRuleId'], ['GET' => 0], null, false, false, null]],
        6138 => [[['_route' => 'admin_orders_resend_email', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Order\\OrderController::resendEmailAction'], ['orderId', 'orderHistoryId', 'orderStatusId'], ['POST' => 0], null, false, false, null]],
        6160 => [[['_route' => 'admin_orders_preview', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Order\\OrderController::previewAction', '_legacy_controller' => 'AdminOrders'], ['orderId'], ['GET' => 0], null, false, false, null]],
        6183 => [[['_route' => 'admin_orders_update_shipping', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Order\\OrderController::updateShippingAction', '_legacy_controller' => 'AdminOrders'], ['orderId'], ['POST' => 0], null, false, false, null]],
        6216 => [[['_route' => 'admin_orders_update_invoice_note', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Order\\OrderController::updateInvoiceNoteAction'], ['orderId', 'orderInvoiceId'], ['POST' => 0], null, false, false, null]],
        6238 => [[['_route' => 'admin_orders_generate_invoice', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Order\\OrderController::generateInvoiceAction', '_legacy_controller' => 'AdminOrders'], ['orderId'], ['POST' => 0], null, false, false, null]],
        6269 => [[['_route' => 'admin_orders_send_message', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Order\\OrderController::sendMessageAction', '_legacy_controller' => 'AdminOrders'], ['orderId'], ['POST' => 0], null, false, false, null]],
        6299 => [[['_route' => 'admin_orders_partial_refund', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Order\\OrderController::partialRefundAction', '_legacy_controller' => 'AdminOrders'], ['orderId'], ['POST' => 0], null, false, false, null]],
        6330 => [[['_route' => 'admin_orders_standard_refund', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Order\\OrderController::standardRefundAction', '_legacy_controller' => 'AdminOrders'], ['orderId'], ['POST' => 0], null, false, false, null]],
        6360 => [[['_route' => 'admin_orders_return_product', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Order\\OrderController::returnProductAction', '_legacy_controller' => 'AdminOrders'], ['orderId'], ['POST' => 0], null, false, false, null]],
        6383 => [[['_route' => 'admin_orders_add_product', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Order\\OrderController::addProductAction', '_legacy_controller' => 'AdminOrders'], ['orderId'], ['POST' => 0], null, false, false, null]],
        6419 => [[['_route' => 'admin_orders_delete_product', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Order\\OrderController::deleteProductAction', '_legacy_controller' => 'AdminOrders'], ['orderId', 'orderDetailId'], ['POST' => 0], null, false, false, null]],
        6443 => [[['_route' => 'admin_orders_get_discounts', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Order\\OrderController::getDiscountsAction', '_legacy_controller' => 'AdminOrders'], ['orderId'], ['GET' => 0], null, false, false, null]],
        6464 => [[['_route' => 'admin_orders_get_prices', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Order\\OrderController::getPricesAction', '_legacy_controller' => 'AdminOrders'], ['orderId'], ['GET' => 0], null, false, false, null]],
        6487 => [[['_route' => 'admin_orders_get_payments', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Order\\OrderController::getPaymentsAction', '_legacy_controller' => 'AdminOrders'], ['orderId'], ['GET' => 0], null, false, false, null]],
        6510 => [[['_route' => 'admin_orders_get_products', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Order\\OrderController::getProductsListAction', '_legacy_controller' => 'AdminOrders'], ['orderId'], ['GET' => 0], null, false, false, null]],
        6533 => [[['_route' => 'admin_orders_get_invoices', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Order\\OrderController::getInvoicesAction', '_legacy_controller' => 'AdminOrders'], ['orderId'], ['GET' => 0], null, false, false, null]],
        6557 => [[['_route' => 'admin_orders_get_documents', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Order\\OrderController::getDocumentsAction', '_legacy_controller' => 'AdminOrders'], ['orderId'], ['GET' => 0], null, false, false, null]],
        6580 => [[['_route' => 'admin_orders_get_shipping', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Order\\OrderController::getShippingAction', '_legacy_controller' => 'AdminOrders'], ['orderId'], ['GET' => 0], null, false, false, null]],
        6607 => [[['_route' => 'admin_orders_cancellation', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Order\\OrderController::cancellationAction', '_legacy_controller' => 'AdminOrders'], ['orderId'], ['POST' => 0], null, false, false, null]],
        6656 => [[['_route' => 'admin_orders_display_customization_image', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Order\\OrderController::displayCustomizationImageAction', '_legacy_controller' => 'AdminOrders'], ['orderId', 'value'], ['GET' => 0], null, false, true, null]],
        6686 => [[['_route' => 'admin_orders_product_prices', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Order\\OrderController::getProductPricesAction', '_legacy_controller' => 'AdminOrders'], ['orderId'], ['GET' => 0], null, false, false, null]],
        6720 => [[['_route' => 'admin_orders_set_internal_note', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Order\\OrderController::setInternalNoteAction', '_legacy_controller' => 'AdminOrders', '_legacy_link' => 'AdminOrders:updateInternalNote', '_legacy_parameters' => ['id_order' => 'orderId']], ['orderId'], ['POST' => 0], null, false, false, null]],
        6752 => [[['_route' => 'admin_credit_slips_generate_pdf', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Sell\\Order\\CreditSlipController::generatePdfAction', '_legacy_controller' => 'AdminSlip', '_legacy_link' => 'AdminSlip:submitgenerateOrderSlipPdf', '_legacy_parameters' => ['id_order_slip' => 'creditSlipId']], ['creditSlipId'], ['GET' => 0], null, false, false, null]],
        6815 => [[['_route' => 'admin_languages_edit', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Improve\\International\\LanguageController::editAction', '_legacy_controller' => 'AdminLanguages', '_legacy_link' => 'AdminLanguages:updatelang'], ['languageId'], ['GET' => 0, 'POST' => 1], null, false, false, null]],
        6836 => [[['_route' => 'admin_languages_delete', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Improve\\International\\LanguageController::deleteAction', '_legacy_controller' => 'AdminLanguages', '_legacy_link' => 'AdminLanguages:deletelang'], ['languageId'], ['POST' => 0, 'DELETE' => 1], null, false, false, null]],
        6868 => [[['_route' => 'admin_languages_toggle_status', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Improve\\International\\LanguageController::toggleStatusAction', '_legacy_controller' => 'AdminLanguages', '_legacy_link' => 'AdminLanguages:statuslang'], ['languageId'], ['POST' => 0], null, false, false, null]],
        6914 => [[['_route' => 'admin_languages_bulk_toggle_status', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Improve\\International\\LanguageController::bulkToggleStatusAction', '_legacy_controller' => 'AdminLanguages', '_legacy_link' => 'AdminLanguages:submitBulkupdatelang'], ['status'], ['POST' => 0], null, false, true, null]],
        6951 => [[['_route' => 'admin_currencies_edit', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Improve\\International\\CurrencyController::editAction', '_legacy_controller' => 'AdminCurrencies', '_legacy_link' => 'AdminCurrencies:updatecurrency', '_legacy_parameters' => ['id_currency' => 'currencyId']], ['currencyId'], ['GET' => 0, 'POST' => 1], null, false, false, null]],
        6972 => [[['_route' => 'admin_currencies_delete', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Improve\\International\\CurrencyController::deleteAction', '_legacy_controller' => 'AdminCurrencies', '_legacy_link' => 'AdminCurrencies:deletecurrency', '_legacy_parameters' => ['id_currency' => 'currencyId']], ['currencyId'], ['DELETE' => 0], null, false, false, null]],
        7001 => [[['_route' => 'admin_currencies_toggle_status', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Improve\\International\\CurrencyController::toggleStatusAction', '_legacy_controller' => 'AdminCurrencies', '_legacy_link' => 'AdminCurrencies:statuscurrency', '_legacy_parameters' => ['id_currency' => 'currencyId']], ['currencyId'], ['POST' => 0], null, false, false, null]],
        7034 => [[['_route' => 'admin_currencies_get_reference_data', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Improve\\International\\CurrencyController::getReferenceDataAction', '_legacy_controller' => 'AdminCurrencies', '_legacy_link' => 'AdminCurrencies:getReferenceData'], ['currencyIsoCode'], ['GET' => 0], null, false, true, null]],
        7080 => [[['_route' => 'admin_currencies_bulk_toggle_status', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Improve\\International\\CurrencyController::bulkToggleStatusAction', '_legacy_controller' => 'AdminCurrencies', '_legacy_link' => 'AdminCurrencies:submitBulkupdatecurrency'], ['status'], ['POST' => 0], null, false, true, null]],
        7109 => [[['_route' => 'admin_countries_edit', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Improve\\International\\CountryController::editAction', '_legacy_controller' => 'AdminCountry', '_legacy_parameters' => ['id_country' => 'countryId']], ['countryId'], ['GET' => 0, 'POST' => 1], null, false, false, null]],
        7141 => [[['_route' => 'admin_taxes_edit', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Improve\\International\\TaxController::editAction', '_legacy_controller' => 'AdminTaxes', '_legacy_link' => 'AdminTaxes:updatetax', '_legacy_parameters' => ['id_tax' => 'taxId']], ['taxId'], ['GET' => 0, 'POST' => 1], null, false, false, null]],
        7162 => [[['_route' => 'admin_taxes_delete', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Improve\\International\\TaxController::deleteAction', '_legacy_controller' => 'AdminTaxes', '_legacy_link' => 'AdminTaxes:deletetax', '_legacy_parameters' => ['id_tax' => 'taxId']], ['taxId'], ['POST' => 0], null, false, false, null]],
        7191 => [[['_route' => 'admin_taxes_toggle_status', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Improve\\International\\TaxController::toggleStatusAction', '_legacy_controller' => 'AdminTaxes', '_legacy_link' => 'AdminTaxes:statustax', '_legacy_parameters' => ['id_tax' => 'taxId']], ['taxId'], ['POST' => 0], null, false, false, null]],
        7228 => [[['_route' => 'admin_tax_rules_groups_edit', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Improve\\International\\TaxRulesGroupController::editAction', '_legacy_controller' => 'AdminTaxRulesGroup', '_legacy_parameters' => ['id_tax_rules_group' => 'taxRulesGroupId']], ['taxRulesGroupId'], ['GET' => 0, 'POST' => 1], null, false, false, null]],
        7249 => [[['_route' => 'admin_tax_rules_groups_delete', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Improve\\International\\TaxRulesGroupController::deleteAction', '_legacy_controller' => 'AdminTaxRulesGroup', '_legacy_parameters' => ['id_tax_rules_group' => 'taxRulesGroupId']], ['taxRulesGroupId'], ['POST' => 0, 'DELETE' => 1], null, false, false, null]],
        7278 => [[['_route' => 'admin_tax_rules_groups_toggle_status', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Improve\\International\\TaxRulesGroupController::toggleStatusAction', '_legacy_controller' => 'AdminTaxRulesGroup', '_legacy_parameters' => ['id_tax_rules_group' => 'taxRulesGroupId']], ['taxRulesGroupId'], ['POST' => 0], null, false, false, null]],
        7309 => [[['_route' => 'admin_states_edit', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Improve\\International\\StateController::editAction', '_legacy_controller' => 'AdminStates', '_legacy_parameters' => ['id_state' => 'stateId']], ['stateId'], ['GET' => 0, 'POST' => 1], null, false, false, null]],
        7330 => [[['_route' => 'admin_states_delete', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Improve\\International\\StateController::deleteAction', '_legacy_controller' => 'AdminStates', '_legacy_parameters' => ['id_state' => 'stateId']], ['stateId'], ['DELETE' => 0], null, false, false, null]],
        7362 => [[['_route' => 'admin_states_toggle_status', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Improve\\International\\StateController::toggleStatusAction', '_legacy_controller' => 'AdminStates', '_legacy_parameters' => ['id_state' => 'stateId']], ['stateId'], ['POST' => 0], null, false, false, null]],
        7391 => [[['_route' => 'admin_zones_edit', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Improve\\International\\ZoneController::editAction', '_legacy_controller' => 'AdminZones', '_legacy_link' => 'AdminZones:updatezone', '_legacy_parameters' => ['id_zone' => 'zoneId']], ['zoneId'], ['GET' => 0, 'POST' => 1], null, false, false, null]],
        7412 => [[['_route' => 'admin_zones_delete', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Improve\\International\\ZoneController::deleteAction', '_legacy_controller' => 'AdminZones', '_legacy_link' => 'AdminZones:deletezone', '_legacy_parameters' => ['id_zone' => 'zoneId']], ['zoneId'], ['POST' => 0, 'DELETE' => 1], null, false, false, null]],
        7441 => [[['_route' => 'admin_zones_toggle_status', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Improve\\International\\ZoneController::toggleStatusAction', '_legacy_controller' => 'AdminZones', '_legacy_link' => 'AdminZones:enableSelection', '_legacy_parameters' => ['id_zone' => 'zoneId']], ['zoneId'], ['POST' => 0], null, false, false, null]],
        7487 => [[['_route' => 'admin_zones_bulk_toggle_status', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Improve\\International\\ZoneController::bulkToggleStatus', '_legacy_controller' => 'AdminZones', '_legacy_link' => 'AdminZones:submitBulkupdatezone'], ['status'], ['POST' => 0], null, false, true, null]],
        7543 => [[['_route' => 'admin_module_manage', 'category' => null, 'keyword' => null, '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Improve\\ModuleController::manageAction', '_legacy_controller' => 'AdminModulesManage', '_legacy_link' => ['AdminModulesManage', 'AdminModulesSf']], ['category', 'keyword'], ['GET' => 0], null, false, true, null]],
        7650 => [[['_route' => 'admin_module_manage_action', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Improve\\ModuleController::moduleAction'], ['action', 'module_name'], ['POST' => 0], null, false, true, null]],
        7677 => [[['_route' => 'admin_module_configure_action', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Improve\\ModuleController::configureModuleAction', '_legacy_controller' => 'AdminModules'], ['module_name'], ['GET' => 0, 'POST' => 1], null, false, true, null]],
        7750 => [[['_route' => 'admin_module_manage_action_bulk', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Improve\\ModuleController::moduleAction'], ['action'], ['POST' => 0], null, false, true, null]],
        7769 => [[['_route' => 'admin_module_manage_update_all', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Improve\\ModuleController::moduleAction'], [], ['POST' => 0], null, false, false, null]],
        7824 => [[['_route' => 'admin_themes_enable', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Improve\\Design\\ThemeController::enableAction', '_legacy_controller' => 'AdminThemes', '_legacy_link' => 'AdminThemes:enableTheme', '_legacy_parameters' => ['theme_name' => 'themeName']], ['themeName'], ['POST' => 0], null, false, false, null]],
        7857 => [[['_route' => 'admin_themes_delete', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Improve\\Design\\ThemeController::deleteAction', '_legacy_controller' => 'AdminThemes', '_legacy_link' => 'AdminThemes:deleteTheme', '_legacy_parameters' => ['theme_name' => 'themeName']], ['themeName'], ['POST' => 0], null, false, false, null]],
        7898 => [[['_route' => 'admin_themes_reset_layouts', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Improve\\Design\\ThemeController::resetLayoutsAction', '_legacy_controller' => 'AdminThemes', '_legacy_link' => 'AdminThemes:resetToDefaults', '_legacy_parameters' => ['theme_name' => 'themeName']], ['themeName'], ['POST' => 0], null, false, false, null]],
        7932 => [[['_route' => 'admin_cms_pages_edit', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Improve\\Design\\CmsPageController::editAction', '_legacy_controller' => 'AdminCmsContent', '_legacy_link' => 'AdminCmsContent:updatecms', '_legacy_parameters' => ['id_cms' => 'cmsPageId']], ['cmsPageId'], ['GET' => 0, 'POST' => 1], null, false, false, null]],
        7961 => [[['_route' => 'admin_cms_pages_toggle', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Improve\\Design\\CmsPageController::toggleCmsAction', '_legacy_controller' => 'AdminCmsContent', '_legacy_link' => 'AdminCmsContent:statuscms', '_legacy_parameters' => ['id_cms' => 'cmsId']], ['cmsId'], ['POST' => 0], null, false, false, null]],
        7982 => [[['_route' => 'admin_cms_pages_delete', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Improve\\Design\\CmsPageController::deleteCmsAction', '_legacy_controller' => 'AdminCmsContent', '_legacy_link' => 'AdminCmsContent:deletecms', '_legacy_parameters' => ['id_cms' => 'cmsId']], ['cmsId'], ['DELETE' => 0], null, false, false, null]],
        8013 => [[['_route' => 'admin_cms_pages_category_edit', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Improve\\Design\\CmsPageController::editCmsCategoryAction', '_legacy_controller' => 'AdminCmsContent', '_legacy_link' => 'AdminCmsContent:updatecms_category', '_legacy_parameters' => ['id_cms_category' => 'cmsCategoryId']], ['cmsCategoryId'], ['GET' => 0, 'POST' => 1], null, false, false, null]],
        8034 => [[['_route' => 'admin_cms_pages_category_delete', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Improve\\Design\\CmsPageController::deleteCmsCategoryAction', '_legacy_controller' => 'AdminCmsContent', '_legacy_link' => 'AdminCmsContent:deletecms_category', '_legacy_parameters' => ['id_cms_category' => 'cmsCategoryId']], ['cmsCategoryId'], ['DELETE' => 0], null, false, false, null]],
        8063 => [[['_route' => 'admin_cms_pages_category_toggle', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Improve\\Design\\CmsPageController::toggleCmsCategoryAction', '_legacy_controller' => 'AdminCmsContent', '_legacy_link' => 'AdminCmsContent:statuscms_category', '_legacy_parameters' => ['id_cms_category' => 'cmsCategoryId']], ['cmsCategoryId'], ['POST' => 0], null, false, false, null]],
        8133 => [[['_route' => 'admin_mail_theme_send_test_mail_deprecated', '_controller' => 'Symfony\\Bundle\\FrameworkBundle\\Controller\\RedirectController::redirectAction', 'route' => 'admin_mail_theme_send_test_mail', 'permanent' => true], ['locale', 'theme', 'layout'], null, null, false, true, null]],
        8151 => [[['_route' => 'admin_mail_theme_send_test_module_mail_deprecated', '_controller' => 'Symfony\\Bundle\\FrameworkBundle\\Controller\\RedirectController::redirectAction', 'route' => 'admin_mail_theme_send_test_module_mail', 'permanent' => true], ['locale', 'theme', 'module', 'layout'], ['GET' => 0], null, false, true, null]],
        8203 => [[['_route' => 'admin_mail_theme_send_test_mail', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Improve\\Design\\MailThemeController::sendTestMailAction', '_legacy_link' => 'AdminMailTheme:rawModuleLayout', '_legacy_controller' => 'AdminMailTheme', 'module' => ''], ['locale', 'theme', 'layout'], ['GET' => 0], null, false, true, null]],
        8221 => [[['_route' => 'admin_mail_theme_send_test_module_mail', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Improve\\Design\\MailThemeController::sendTestMailAction', '_legacy_link' => 'AdminMailTheme:rawModuleLayout', '_legacy_controller' => 'AdminMailTheme'], ['locale', 'theme', 'module', 'layout'], ['GET' => 0], null, false, true, null]],
        8251 => [[['_route' => 'admin_mail_theme_preview', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Improve\\Design\\MailThemeController::previewThemeAction', '_legacy_controller' => 'AdminMailTheme', '_legacy_link' => 'AdminMailTheme:previewTheme'], ['theme'], ['GET' => 0], null, false, true, null]],
        8293 => [[['_route' => 'admin_mail_theme_preview_layout', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Improve\\Design\\MailThemeController::previewLayoutAction', '_legacy_controller' => 'AdminMailTheme', '_legacy_link' => 'AdminMailTheme:previewLayout', 'module' => ''], ['locale', 'theme', 'layout', 'type'], ['GET' => 0], null, false, true, null]],
        8331 => [[['_route' => 'admin_mail_theme_preview_module_layout', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Improve\\Design\\MailThemeController::previewLayoutAction', '_legacy_controller' => 'AdminMailTheme', '_legacy_link' => 'AdminMailTheme:previewModuleLayout'], ['locale', 'theme', 'module', 'layout', 'type'], ['GET' => 0], null, false, true, null]],
        8387 => [[['_route' => 'admin_mail_theme_raw_layout', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Improve\\Design\\MailThemeController::rawLayoutAction', '_legacy_controller' => 'AdminMailTheme', '_legacy_link' => 'AdminMailTheme:rawLayout', 'module' => ''], ['locale', 'theme', 'layout', 'type'], ['GET' => 0], null, false, true, null]],
        8425 => [[['_route' => 'admin_mail_theme_raw_module_layout', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Improve\\Design\\MailThemeController::rawLayoutAction', '_legacy_link' => 'AdminMailTheme:rawModuleLayout', '_legacy_controller' => 'AdminMailTheme'], ['locale', 'theme', 'module', 'layout', 'type'], ['GET' => 0], null, false, true, null]],
        8468 => [[['_route' => 'admin_carriers_edit', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Improve\\Shipping\\CarriersController::editAction'], ['carrierId'], ['GET' => 0], null, false, false, null]],
        8489 => [[['_route' => 'admin_carriers_delete', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Improve\\Shipping\\CarriersController::deleteAction', '_legacy_controller' => 'AdminCarriers', '_legacy_parameters' => ['id_carrier' => 'carrierId']], ['carrierId'], ['POST' => 0, 'DELETE' => 1], null, false, false, null]],
        8518 => [[['_route' => 'admin_carriers_toggle_status', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Improve\\Shipping\\CarriersController::toggleStatusAction', '_legacy_controller' => 'AdminCarriers', '_legacy_parameters' => ['id_carrier' => 'carrierId']], ['carrierId'], ['POST' => 0], null, false, false, null]],
        8549 => [[['_route' => 'admin_carriers_toggle_is_free', '_controller' => 'PrestaShopBundle\\Controller\\Admin\\Improve\\Shipping\\CarriersController::toggleIsFreeAction', '_legacy_controller' => 'AdminCarriers', '_legacy_parameters' => ['id_carrier' => 'carrierId']], ['carrierId'], ['POST' => 0], null, false, false, null]],
        8586 => [[['_route' => 'api_stock_list_product_combinations', '_controller' => 'prestashop.core.api.stock.controller:listProductsAction', '_legacy_controller' => 'AdminStockManagement'], ['productId'], ['GET' => 0], null, false, true, null]],
        8611 => [[['_route' => 'api_stock_edit_product', '_controller' => 'prestashop.core.api.stock.controller:editProductAction', '_legacy_controller' => 'AdminStockManagement'], ['productId'], ['POST' => 0], null, false, true, null]],
        8643 => [[['_route' => 'api_stock_edit_product_combination', '_controller' => 'prestashop.core.api.stock.controller:editProductAction', '_legacy_controller' => 'AdminStockManagement'], ['productId', 'combinationId'], ['POST' => 0], null, false, true, null]],
        8679 => [[['_route' => 'api_stock_product_list_movements', '_controller' => 'prestashop.core.api.stock_movement.controller:listMovementsAction', '_legacy_controller' => 'AdminStockManagement'], ['productId'], ['GET' => 0], null, false, true, null]],
        8699 => [[['_route' => 'api_i18n_translations_list', '_controller' => 'prestashop.core.api.i18n.controller:listTranslationAction'], ['page'], ['GET' => 0], null, false, true, null]],
        8760 => [[['_route' => 'api_translation_domains_tree', '_controller' => 'prestashop.core.api.translation.controller:listTreeAction', '_legacy_controller' => 'AdminTranslations', 'selected' => null], ['lang', 'type', 'selected'], ['GET' => 0], null, false, true, null]],
        8800 => [[['_route' => 'api_translation_domain_catalog', '_controller' => 'prestashop.core.api.translation.controller:listDomainTranslationAction', '_legacy_controller' => 'AdminTranslations', 'theme' => null, 'module' => null], ['locale', 'domain', 'theme'], ['GET' => 0], null, false, true, null]],
        8852 => [
        ...
        8874 => [[['_route' => 'admin_link_block_delete', '_controller' => 'PrestaShop\\Module\\LinkList\\Controller\\Admin\\Improve\\Design\\LinkBlockController::deleteAction', '_legacy_controller' => 'AdminLinkWidget'], ['linkBlockId'], ['POST' => 0], null, false, true, null]],
        8906 => [
