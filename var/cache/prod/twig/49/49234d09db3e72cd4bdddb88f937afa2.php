...
class __TwigTemplate_7de604ba7de81c607e59ee7571f6efb3 extends Template
{
    private $source;
    private $macros = [];
  ...
  <div class=\"col-md-9\">
    <div class=\"alert alert-info\" role=\"alert\">
      <p class=\"alert-text\">
        ";
        // line 127
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("Default behavior is specified in the Shop Parameters > Product settings page.", [], "Admin.Catalog.Help"), "html", null, true);
        echo "<br>
        ";
        // line 128
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("No redirection (200), display product = Do not redirect anywhere, display product as discontinued and return normal 200 response.", [], "Admin.Catalog.Help"), "html", null, true);
        echo "<br>
        ";
        // line 129
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("No redirection (404), display product = Do not redirect anywhere, display product as discontinued and return 404 \"Not Found\" response.", [], "Admin.Catalog.Help"), "html", null, true);
        echo "<br>
        ";
        // line 130
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("No redirection (410), display product = Do not redirect anywhere, display product as discontinued and return 410 \"Gone\" response.", [], "Admin.Catalog.Help"), "html", null, true);
        echo "<br>
        ";
        // line 131
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("No redirection (404), display error page = Do not redirect anywhere and display a 404 \"Not Found\" page.", [], "Admin.Catalog.Help"), "html", null, true);
        echo "<br>
        ";
        // line 132
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("No redirection (410), display error page = Do not redirect anywhere and display a 410 \"Gone\" page.", [], "Admin.Catalog.Help"), "html", null, true);
        echo "<br>
        ";
        // line 133
...
";
    ...
    {
        return array (  288 => 32,  283 => 30,  279 => 29,  273 => 142,  268 => 140,  259 => 134,  255 => 133,  251 => 132,  247 => 131,  243 => 130,  239 => 129,  235 => 128,  231 => 127,  219 => 118,  215 => 117,  211 => 116,  202 => 110,  198 => 109,  194 => 108,  183 => 100,  177 => 97,  169 => 91,  163 => 89,  158 => 87,  156 => 86,  152 => 84,  147 => 82,  142 => 81,  137 => 79,  132 => 78,  130 => 77,  118 => 68,  112 => 65,  106 => 62,  100 => 59,  94 => 56,  85 => 50,  81 => 49,  77 => 48,  66 => 40,  62 => 39,  58 => 38,  52 => 34,  50 => 29,  45 => 27,  41 => 26,  38 => 25,);
    }
