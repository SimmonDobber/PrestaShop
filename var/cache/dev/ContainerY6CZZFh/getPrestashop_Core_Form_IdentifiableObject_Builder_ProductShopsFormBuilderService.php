...
return $this->services['prestashop.core.form.identifiable_object.builder.product_shops_form_builder'] = ($this->services['prestashop.core.form.builder.form_builder_factory'] ?? $this->load('getPrestashop_Core_Form_Builder_FormBuilderFactoryService.php'))->create('PrestaShopBundle\\Form\\Admin\\Sell\\Product\\ProductShopsType', ($this->services['prestashop.core.form.identifiable_object.data_provider.product_shops_form_data_provider'] ?? $this->load('getPrestashop_Core_Form_IdentifiableObject_DataProvider_ProductShopsFormDataProviderService.php')));
