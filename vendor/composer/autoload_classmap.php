...
return array(
    'AdminAjaxPsgdprController' => $baseDir . '/modules/psgdpr/controllers/admin/AdminAjaxPsgdprController.php',
    ...
    'AdminDownloadInvoicesPsgdprController' => $baseDir . '/modules/psgdpr/controllers/admin/AdminDownloadInvoicesPsgdprController.php',
    'AdminGanalyticsAjaxController' => $baseDir . '/modules/ps_googleanalytics/controllers/admin/AdminGanalyticsAjax.php',
    ...
    'BlockWishList' => $baseDir . '/modules/blockwishlist/blockwishlist.php',
    'BlockWishListActionModuleFrontController' => $baseDir . '/modules/blockwishlist/controllers/front/action.php',
    'BlockWishlistListsModuleFrontController' => $baseDir . '/modules/blockwishlist/controllers/front/lists.php',
    'BlockWishlistViewModuleFrontController' => $baseDir . '/modules/blockwishlist/controllers/front/view.php',
    'Collator' => $vendorDir . '/symfony/symfony/src/Symfony/Component/Intl/Resources/stubs/Collator.php',
    'Composer\\InstalledVersions' => $vendorDir . '/composer/InstalledVersions.php',
    'CustomText' => $baseDir . '/modules/ps_customtext/classes/CustomText.php',
    'Datamatrix' => $vendorDir . '/tecnickcom/tcpdf/include/barcodes/datamatrix.php',
    'GDPRConsent' => $baseDir . '/modules/psgdpr/classes/GDPRConsent.php',
    'GDPRLog' => $baseDir . '/modules/psgdpr/classes/GDPRLog.php',
    'HTMLTemplatePSGDPRModule' => $baseDir . '/modules/psgdpr/classes/HTMLTemplatePSGDPRModule.php',
    ...
    'MigrateData' => $baseDir . '/modules/ps_customtext/classes/MigrateData.php',
    ...
    'PrestaShop\\Module\\Ps_Googleanalytics\\Database\\Install' => $baseDir . '/modules/ps_googleanalytics/classes/Database/Install.php',
    'PrestaShop\\Module\\Ps_Googleanalytics\\Database\\Uninstall' => $baseDir . '/modules/ps_googleanalytics/classes/Database/Uninstall.php',
    'PrestaShop\\Module\\Ps_Googleanalytics\\Form\\ConfigurationForm' => $baseDir . '/modules/ps_googleanalytics/classes/Form/ConfigurationForm.php',
    'PrestaShop\\Module\\Ps_Googleanalytics\\GoogleAnalyticsTools' => $baseDir . '/modules/ps_googleanalytics/classes/GoogleAnalyticsTools.php',
    'PrestaShop\\Module\\Ps_Googleanalytics\\Handler\\GanalyticsDataHandler' => $baseDir . '/modules/ps_googleanalytics/classes/Handler/GanalyticsDataHandler.php',
    'PrestaShop\\Module\\Ps_Googleanalytics\\Handler\\GanalyticsJsHandler' => $baseDir . '/modules/ps_googleanalytics/classes/Handler/GanalyticsJsHandler.php',
    'PrestaShop\\Module\\Ps_Googleanalytics\\Handler\\ModuleHandler' => $baseDir . '/modules/ps_googleanalytics/classes/Handler/ModuleHandler.php',
    'PrestaShop\\Module\\Ps_Googleanalytics\\Hooks\\HookActionCarrierProcess' => $baseDir . '/modules/ps_googleanalytics/classes/Hook/HookActionCarrierProcess.php',
    'PrestaShop\\Module\\Ps_Googleanalytics\\Hooks\\HookActionCartSave' => $baseDir . '/modules/ps_googleanalytics/classes/Hook/HookActionCartSave.php',
    'PrestaShop\\Module\\Ps_Googleanalytics\\Hooks\\HookActionOrderStatusPostUpdate' => $baseDir . '/modules/ps_googleanalytics/classes/Hook/HookActionOrderStatusPostUpdate.php',
    'PrestaShop\\Module\\Ps_Googleanalytics\\Hooks\\HookActionProductCancel' => $baseDir . '/modules/ps_googleanalytics/classes/Hook/HookActionProductCancel.php',
    'PrestaShop\\Module\\Ps_Googleanalytics\\Hooks\\HookDisplayBackOfficeHeader' => $baseDir . '/modules/ps_googleanalytics/classes/Hook/HookDisplayBackOfficeHeader.php',
    'PrestaShop\\Module\\Ps_Googleanalytics\\Hooks\\HookDisplayFooter' => $baseDir . '/modules/ps_googleanalytics/classes/Hook/HookDisplayFooter.php',
    'PrestaShop\\Module\\Ps_Googleanalytics\\Hooks\\HookDisplayFooterProduct' => $baseDir . '/modules/ps_googleanalytics/classes/Hook/HookDisplayFooterProduct.php',
    'PrestaShop\\Module\\Ps_Googleanalytics\\Hooks\\HookDisplayHeader' => $baseDir . '/modules/ps_googleanalytics/classes/Hook/HookDisplayHeader.php',
    'PrestaShop\\Module\\Ps_Googleanalytics\\Hooks\\HookDisplayHome' => $baseDir . '/modules/ps_googleanalytics/classes/Hook/HookDisplayHome.php',
    'PrestaShop\\Module\\Ps_Googleanalytics\\Hooks\\HookDisplayOrderConfirmation' => $baseDir . '/modules/ps_googleanalytics/classes/Hook/HookDisplayOrderConfirmation.php',
    'PrestaShop\\Module\\Ps_Googleanalytics\\Hooks\\HookInterface' => $baseDir . '/modules/ps_googleanalytics/classes/Hook/HookInterface.php',
    'PrestaShop\\Module\\Ps_Googleanalytics\\Hooks\\WrapperInterface' => $baseDir . '/modules/ps_googleanalytics/classes/Wrapper/WrapperInterface.php',
    'PrestaShop\\Module\\Ps_Googleanalytics\\Repository\\CarrierRepository' => $baseDir . '/modules/ps_googleanalytics/classes/Repository/CarrierRepository.php',
    'PrestaShop\\Module\\Ps_Googleanalytics\\Repository\\GanalyticsDataRepository' => $baseDir . '/modules/ps_googleanalytics/classes/Repository/GanalyticsDataRepository.php',
    'PrestaShop\\Module\\Ps_Googleanalytics\\Repository\\GanalyticsRepository' => $baseDir . '/modules/ps_googleanalytics/classes/Repository/GanalyticsRepository.php',
    'PrestaShop\\Module\\Ps_Googleanalytics\\Wrapper\\OrderWrapper' => $baseDir . '/modules/ps_googleanalytics/classes/Wrapper/OrderWrapper.php',
    'PrestaShop\\Module\\Ps_Googleanalytics\\Wrapper\\ProductWrapper' => $baseDir . '/modules/ps_googleanalytics/classes/Wrapper/ProductWrapper.php',
    'ProductComments' => $baseDir . '/modules/productcomments/productcomments.php',
    'Ps_Banner' => $baseDir . '/modules/ps_banner/ps_banner.php',
    'Ps_Cashondelivery' => $baseDir . '/modules/ps_cashondelivery/ps_cashondelivery.php',
    'Ps_CashondeliveryValidationModuleFrontController' => $baseDir . '/modules/ps_cashondelivery/controllers/front/validation.php',
    'Ps_CategoryTree' => $baseDir . '/modules/ps_categorytree/ps_categorytree.php',
    'Ps_Checkpayment' => $baseDir . '/modules/ps_checkpayment/ps_checkpayment.php',
    'Ps_CheckpaymentPaymentModuleFrontController' => $baseDir . '/modules/ps_checkpayment/controllers/front/payment.php',
    'Ps_CheckpaymentValidationModuleFrontController' => $baseDir . '/modules/ps_checkpayment/controllers/front/validation.php',
    'Ps_Crossselling' => $baseDir . '/modules/ps_crossselling/ps_crossselling.php',
    'Ps_CustomerSignIn' => $baseDir . '/modules/ps_customersignin/ps_customersignin.php',
    'Ps_Customeraccountlinks' => $baseDir . '/modules/ps_customeraccountlinks/ps_customeraccountlinks.php',
    'Ps_Customtext' => $baseDir . '/modules/ps_customtext/ps_customtext.php',
    'Ps_Distributionapiclient' => $baseDir . '/modules/ps_distributionapiclient/ps_distributionapiclient.php',
    'Ps_Emailsubscription' => $baseDir . '/modules/ps_emailsubscription/ps_emailsubscription.php',
    'Ps_Facetedsearch' => $baseDir . '/modules/ps_facetedsearch/ps_facetedsearch.php',
    'Ps_FeaturedProducts' => $baseDir . '/modules/ps_featuredproducts/ps_featuredproducts.php',
    'Ps_Googleanalytics' => $baseDir . '/modules/ps_googleanalytics/ps_googleanalytics.php',
    'Ps_ImageSlider' => $baseDir . '/modules/ps_imageslider/ps_imageslider.php',
    'Ps_Linklist' => $baseDir . '/modules/ps_linklist/ps_linklist.php',
    'Ps_MainMenu' => $baseDir . '/modules/ps_mainmenu/ps_mainmenu.php',
    'Ps_Shoppingcart' => $baseDir . '/modules/ps_shoppingcart/ps_shoppingcart.php',
    'Ps_ShoppingcartAjaxModuleFrontController' => $baseDir . '/modules/ps_shoppingcart/controllers/front/ajax.php',
    'Ps_Wirepayment' => $baseDir . '/modules/ps_wirepayment/ps_wirepayment.php',
    'Ps_faviconnotificationbo' => $baseDir . '/modules/ps_faviconnotificationbo/ps_faviconnotificationbo.php',
    'Psgdpr' => $baseDir . '/modules/psgdpr/psgdpr.php',
    'QRcode' => $vendorDir . '/tecnickcom/tcpdf/include/barcodes/qrcode.php',
    'ReassuranceActivity' => $baseDir . '/modules/blockreassurance/classes/ReassuranceActivity.php',
    ...
    'Statistics' => $baseDir . '/modules/blockwishlist/classes/Statistics.php',
    ...
    'WishList' => $baseDir . '/modules/blockwishlist/classes/WishList.php',
    'blockreassurance' => $baseDir . '/modules/blockreassurance/blockreassurance.php',
    'dashtrends' => $baseDir . '/modules/dashtrends/dashtrends.php',
    ...
    'ps_GoogleanalyticsAjaxModuleFrontController' => $baseDir . '/modules/ps_googleanalytics/controllers/front/ajax.php',
    'ps_themecusto' => $baseDir . '/modules/ps_themecusto/ps_themecusto.php',
    'psgdprExportDataToCsvModuleFrontController' => $baseDir . '/modules/psgdpr/controllers/front/ExportDataToCsv.php',
    'psgdprExportDataToPdfModuleFrontController' => $baseDir . '/modules/psgdpr/controllers/front/ExportDataToPdf.php',
    'psgdprFrontAjaxGdprModuleFrontController' => $baseDir . '/modules/psgdpr/controllers/front/FrontAjaxGdpr.php',
    'psgdprgdprModuleFrontController' => $baseDir . '/modules/psgdpr/controllers/front/gdpr.php',
);
