 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:F}=window;class I{extend(t){this.initRowLinks(t),this.initConfirmableActions(t)}initConfirmableActions(t){t.getContainer().on("click",e.linkRowAction,(t=>{const e=F(t.currentTarget).data("confirm-message");e.length&&!window.confirm(e)&&t.preventDefault()}))}initRowLinks(t){F("tr",t.getContainer()).each((function(){const t=F(this);F(e.linkRowActionClickableFirst,t).each((function(){const n=F(this),o=n.closest("td"),i=F(e.clickableTd,t).not(o);let s=!1;i.addClass("cursor-pointer").mousedown((()=>{F(window).mousemove((()=>{s=!0,F(window).unbind("mousemove")}))})),i.mouseup((()=>{const t=s;if(s=!1,F(window).unbind("mousemove"),!t){const t=n.data("confirm-message");(!t.length||window.confirm(t)&&n.attr("href"))&&(document.location.href=n.attr("href"))}}))}))}))}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:P}=window;class D{extend(e){e.getHeaderContainer().on("click",t.gridSubmitAction,(t=>{this.handleSubmit(t,e)}))}handleSubmit(t,e){const n=P(t.currentTarget),o=n.data("confirm-message");if(void 0!==o&&o.length>0&&!window.confirm(o))return;const s=P(_(e.getId()));s.attr("action",n.data("url")),s.attr("method",n.data("method")),s.find(i.tokenInput(e.getId())).val(n.data("csrf")),s.submit()}}var R=n(9567),q=Object.defineProperty,H=Object.getOwnPropertySymbols,z=Object.prototype.hasOwnProperty,G=Object.prototype.propertyIsEnumerable,W=(t,e,n)=>e in t?q(t,e,{enumerable:!0,configurable:!0,writable:!0,value:n}):t[e]=n,N=(t,e)=>{for(var n in e||(e={}))z.call(e,n)&&W(t,n,e[n]);if(H)for(var n of H(e))G.call(e,n)&&W(t,n,e[n]);return t};
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
function U(t){return void 0===t}var J=Object.defineProperty,K=Object.getOwnPropertySymbols,X=Object.prototype.hasOwnProperty,Y=Object.prototype.propertyIsEnumerable,Z=(t,e,n)=>e in t?J(t,e,{enumerable:!0,configurable:!0,writable:!0,value:n}):t[e]=n;
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:Dt}=window;Dt((()=>{const t=new x("zone");t.addExtension(new A),t.addExtension(new j),t.addExtension(new M),t.addExtension(new L),t.addExtension(new I),t.addExtension(new D),t.addExtension(new Ot),t.addExtension(new Tt),t.addExtension(new Mt),t.addExtension(new St),t.addExtension(new Ft),t.addExtension(new At),new Pt("#zone_shop_association").enableAutoCheckChildren()}))})(),window.zone=o})();