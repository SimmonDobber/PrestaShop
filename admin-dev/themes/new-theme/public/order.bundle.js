 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$}=window;class L{extend(e){e.getHeaderContainer().on("click",n.showQuery,(()=>this.onShowSqlQueryClick(e))),e.getHeaderContainer().on("click",n.exportQuery,(()=>this.onExportSqlManagerClick(e)))}onShowSqlQueryClick(e){const t=$(n.showModalForm(e.getId()));this.fillExportForm(t,e);const s=$(n.showModalGrid(e.getId()));s.modal("show"),s.on("click",C,(()=>t.submit()))}onExportSqlManagerClick(e){const t=$(n.showModalForm(e.getId()));this.fillExportForm(t,e),t.submit()}fillExportForm(e,t){const s=t.getContainer().find(a).data("query");e.find('textarea[name="sql"]').val(s),e.find('input[name="name"]').val(this.getNameFromBreadcrumb())}getNameFromBreadcrumb(){const e=$(m).find(p);let t="";return e.each(((e,s)=>{const o=$(s),r=o.find("a").length>0?o.find("a").text():o.text();t.length>0&&(t=t.concat(" > ")),t=t.concat(r)})),t}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:F}=window;class H{extend(e){this.initRowLinks(e),this.initConfirmableActions(e)}initConfirmableActions(e){e.getContainer().on("click",r.linkRowAction,(e=>{const t=F(e.currentTarget).data("confirm-message");t.length&&!window.confirm(t)&&e.preventDefault()}))}initRowLinks(e){F("tr",e.getContainer()).each((function(){const e=F(this);F(r.linkRowActionClickableFirst,e).each((function(){const t=F(this),s=t.closest("td"),o=F(r.clickableTd,e).not(s);let n=!1;o.addClass("cursor-pointer").mousedown((()=>{F(window).mousemove((()=>{n=!0,F(window).unbind("mousemove")}))})),o.mouseup((()=>{const e=n;if(n=!1,F(window).unbind("mousemove"),!e){const e=t.data("confirm-message");(!e.length||window.confirm(e)&&t.attr("href"))&&(document.location.href=t.attr("href"))}}))}))}))}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
function ee(e){return void 0===e}var te=Object.defineProperty,se=Object.getOwnPropertySymbols,oe=Object.prototype.hasOwnProperty,re=Object.prototype.propertyIsEnumerable,ne=(e,t,s)=>t in e?te(e,t,{enumerable:!0,configurable:!0,writable:!0,value:s}):e[t]=s;
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @copyright Since 2007 PrestaShop SA and Contributors
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */const qe=ae,{$:Pe}=window;class je{extend(e){e.getContainer().on("click",o.submitAction,(t=>{this.submit(t,e)}))}submit(e,t){const s=Pe(e.currentTarget),o=s.data("confirm-message"),r=s.data("confirmTitle");void 0!==o&&o.length>0?void 0!==r?this.showConfirmModal(s,t,o,r):window.confirm(o)&&this.postForm(s,t):this.postForm(s,t)}showConfirmModal(e,t,s,o){const r=e.data("confirmButtonLabel"),n=e.data("closeButtonLabel"),a=e.data("confirmButtonClass");new qe({id:i(t.getId()),confirmTitle:o,confirmMessage:s,confirmButtonLabel:r,closeButtonLabel:n,confirmButtonClass:a},(()=>this.postForm(e,t))).show()}postForm(e,t){const s=Pe(O(t.getId()));s.attr("action",e.data("form-url")),s.attr("method",e.data("form-method")),s.submit()}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:Re}=window;class Ge{extend(e){e.getContainer().on("click",o.modalFormSubmitBtn,(t=>{const s=Re(t.target).data("modal-id"),r=Re(`#${s}`);r.modal("show"),r.find(n.submitModalFormBtn).on("click",(()=>{const t=r.find("form"),s=t.find(n.bulkInputsBlock(t.data("bulk-inputs-id")));e.getContainer().find(o.checkedCheckbox).each(((e,o)=>{const r=Re(o),n=s.data("prototype").replace(/__name__/g,r.val()),i=Re(Re.parseHTML(n)[0]);i.val(r.val()),t.append(i)})),t.submit()}))}))}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:Ke}=window;class Xe{constructor(){this.router=new Je}extend(e){e.getContainer().on("click",o.openTabsBtn,(t=>{this.openTabs(t,e)}))}openTabs(e,t){const s=Ke(e.currentTarget),r=s.data("route"),n=s.data("routeParamName"),i=s.data("tabsBlockedMessage"),a=t.getContainer().find(o.checkedCheckbox);let d=!0;a.each(((e,t)=>{const s=Ke(t),o={};o[n]=s.val();const a=window.open(this.router.generate(r,o));a?(a.blur(),window.focus()):d=!1,d||alert(i)}))}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
