 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:B}=window;class A{extend(t){this.initRowLinks(t),this.initConfirmableActions(t)}initConfirmableActions(t){t.getContainer().on("click",e.linkRowAction,(t=>{const e=B(t.currentTarget).data("confirm-message");e.length&&!window.confirm(e)&&t.preventDefault()}))}initRowLinks(t){B("tr",t.getContainer()).each((function(){const t=B(this);B(e.linkRowActionClickableFirst,t).each((function(){const n=B(this),o=n.closest("td"),i=B(e.clickableTd,t).not(o);let r=!1;i.addClass("cursor-pointer").mousedown((()=>{B(window).mousemove((()=>{r=!0,B(window).unbind("mousemove")}))})),i.mouseup((()=>{const t=r;if(r=!1,B(window).unbind("mousemove"),!t){const t=n.data("confirm-message");(!t.length||window.confirm(t)&&n.attr("href"))&&(document.location.href=n.attr("href"))}}))}))}))}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:M}=window;class T{extend(e){e.getHeaderContainer().on("click",t.gridSubmitAction,(t=>{this.handleSubmit(t,e)}))}handleSubmit(t,e){const n=M(t.currentTarget),o=n.data("confirm-message");if(void 0!==o&&o.length>0&&!window.confirm(o))return;const r=M(p(e.getId()));r.attr("action",n.data("url")),r.attr("method",n.data("method")),r.find(i.tokenInput(e.getId())).val(n.data("csrf")),r.submit()}}var S=n(9567),$=Object.defineProperty,I=Object.getOwnPropertySymbols,F=Object.prototype.hasOwnProperty,P=Object.prototype.propertyIsEnumerable,R=(t,e,n)=>e in t?$(t,e,{enumerable:!0,configurable:!0,writable:!0,value:n}):t[e]=n,D=(t,e)=>{for(var n in e||(e={}))F.call(e,n)&&R(t,n,e[n]);if(I)for(var n of I(e))P.call(e,n)&&R(t,n,e[n]);return t};
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
function N(t){return void 0===t}var W=Object.defineProperty,z=Object.getOwnPropertySymbols,G=Object.prototype.hasOwnProperty,Q=Object.prototype.propertyIsEnumerable,U=(t,e,n)=>e in t?W(t,e,{enumerable:!0,configurable:!0,writable:!0,value:n}):t[e]=n;
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
class At{constructor(){const t=new v("contact");t.addExtension(new w),t.addExtension(new _),t.addExtension(new L),t.addExtension(new j),t.addExtension(new A),t.addExtension(new T),t.addExtension(new yt),t.addExtension(new Ct),t.addExtension(new xt),new Ot,new Bt("#contact_shop_association").enableAutoCheckChildren()}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:Mt}=window;Mt((()=>{new At}))})(),window.contacts=o})();