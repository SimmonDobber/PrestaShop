 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:Bt}=window;class xt{extend(t){this.initRowLinks(t),this.initConfirmableActions(t)}initConfirmableActions(t){t.getContainer().on("click",e.linkRowAction,(t=>{const e=Bt(t.currentTarget).data("confirm-message");e.length&&!window.confirm(e)&&t.preventDefault()}))}initRowLinks(t){Bt("tr",t.getContainer()).each((function(){const t=Bt(this);Bt(e.linkRowActionClickableFirst,t).each((function(){const n=Bt(this),o=n.closest("td"),i=Bt(e.clickableTd,t).not(o);let s=!1;i.addClass("cursor-pointer").mousedown((()=>{Bt(window).mousemove((()=>{s=!0,Bt(window).unbind("mousemove")}))})),i.mouseup((()=>{const t=s;if(s=!1,Bt(window).unbind("mousemove"),!t){const t=n.data("confirm-message");(!t.length||window.confirm(t)&&n.attr("href"))&&(document.location.href=n.attr("href"))}}))}))}))}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
