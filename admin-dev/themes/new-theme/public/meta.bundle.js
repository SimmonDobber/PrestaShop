 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:L}=window,O=function(t,e){L.post(t).then((()=>window.location.assign(e)))},{$:j}=window;class B{extend(t){t.getContainer().on("click",m,(t=>{O(j(t.currentTarget).data("url"),j(t.currentTarget).data("redirect"))}))}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:T}=window;class ${extend(t){this.initRowLinks(t),this.initConfirmableActions(t)}initConfirmableActions(t){t.getContainer().on("click",e.linkRowAction,(t=>{const e=T(t.currentTarget).data("confirm-message");e.length&&!window.confirm(e)&&t.preventDefault()}))}initRowLinks(t){T("tr",t.getContainer()).each((function(){const t=T(this);T(e.linkRowActionClickableFirst,t).each((function(){const n=T(this),o=n.closest("td"),i=T(e.clickableTd,t).not(o);let r=!1;i.addClass("cursor-pointer").mousedown((()=>{T(window).mousemove((()=>{r=!0,T(window).unbind("mousemove")}))})),i.mouseup((()=>{const t=r;if(r=!1,T(window).unbind("mousemove"),!t){const t=n.data("confirm-message");(!t.length||window.confirm(t)&&n.attr("href"))&&(document.location.href=n.attr("href"))}}))}))}))}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:I}=window;class P{extend(e){e.getHeaderContainer().on("click",t.gridSubmitAction,(t=>{this.handleSubmit(t,e)}))}handleSubmit(t,e){const n=I(t.currentTarget),o=n.data("confirm-message");if(void 0!==o&&o.length>0&&!window.confirm(o))return;const r=I(w(e.getId()));r.attr("action",n.data("url")),r.attr("method",n.data("method")),r.find(i.tokenInput(e.getId())).val(n.data("csrf")),r.submit()}}var F=n(9567),R=Object.defineProperty,D=Object.getOwnPropertySymbols,q=Object.prototype.hasOwnProperty,H=Object.prototype.propertyIsEnumerable,N=(t,e,n)=>e in t?R(t,e,{enumerable:!0,configurable:!0,writable:!0,value:n}):t[e]=n,U=(t,e)=>{for(var n in e||(e={}))q.call(e,n)&&N(t,n,e[n]);if(D)for(var n of D(e))H.call(e,n)&&N(t,n,e[n]);return t};
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
function G(t){return void 0===t}var Q=Object.defineProperty,V=Object.getOwnPropertySymbols,K=Object.prototype.hasOwnProperty,J=Object.prototype.propertyIsEnumerable,X=(t,e,n)=>e in t?Q(t,e,{enumerable:!0,configurable:!0,writable:!0,value:n}):t[e]=n;
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:zt}=window;zt((()=>{const t=new C("meta");t.addExtension(new k),t.addExtension(new E),t.addExtension(new B),t.addExtension(new A),t.addExtension(new $),t.addExtension(new P),t.addExtension(new xt),t.addExtension(new jt),t.addExtension(new Lt),t.addExtension(new Rt);new St("seo-urls-showcase-card").addExtension(new At),new $t({tokenFieldSelector:"input.js-taggable-field",options:{createTokensOnBlur:!0}}),new Ft,new qt,window.prestashop.component.initComponents(["MultistoreConfigField"]),new Wt}))})(),window.meta=o})();