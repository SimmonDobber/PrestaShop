 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:w}=window,y=function(t,e){w.post(t).then((()=>window.location.assign(e)))},{$:_}=window;class C{extend(t){t.getContainer().on("click",m,(t=>{y(_(t.currentTarget).data("url"),_(t.currentTarget).data("redirect"))}))}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
class O{extend(t){const e=t.getContainer().find(d);new L(e).attach()}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:_t}=window;class Ct{extend(t){this.initRowLinks(t),this.initConfirmableActions(t)}initConfirmableActions(t){t.getContainer().on("click",e.linkRowAction,(t=>{const e=_t(t.currentTarget).data("confirm-message");e.length&&!window.confirm(e)&&t.preventDefault()}))}initRowLinks(t){_t("tr",t.getContainer()).each((function(){const t=_t(this);_t(e.linkRowActionClickableFirst,t).each((function(){const n=_t(this),o=n.closest("td"),i=_t(e.clickableTd,t).not(o);let r=!1;i.addClass("cursor-pointer").mousedown((()=>{_t(window).mousemove((()=>{r=!0,_t(window).unbind("mousemove")}))})),i.mouseup((()=>{const t=r;if(r=!1,_t(window).unbind("mousemove"),!t){const t=n.data("confirm-message");(!t.length||window.confirm(t)&&n.attr("href"))&&(document.location.href=n.attr("href"))}}))}))}))}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const kt=new(n(7187).EventEmitter),{$:Lt}=window;const Ot=class{constructor(t={}){const e=t||{};this.localeItemSelector=e.localeItemSelector||".js-locale-item",this.localeButtonSelector=e.localeButtonSelector||".js-locale-btn",this.localeInputSelector=e.localeInputSelector||".js-locale-input",this.selectedLocale=Lt(this.localeItemSelector).data("locale"),Lt("body").on("click",this.localeItemSelector,this.toggleLanguage.bind(this)),kt.on("languageSelected",this.toggleInputs.bind(this))}refreshInputs(t){this.selectedLocale&&kt.emit("languageSelected",{selectedLocale:this.selectedLocale,form:t})}toggleLanguage(t){const e=Lt(t.target),n=e.closest("form");this.selectedLocale=e.data("locale"),this.refreshInputs(n)}toggleInputs(t){const{form:e}=t;this.selectedLocale=t.selectedLocale;const n=e.find(this.localeButtonSelector),o=n.data("change-language-url");n.text(this.selectedLocale),e.find(this.localeInputSelector).addClass("d-none"),e.find(`${this.localeInputSelector}.js-locale-${this.selectedLocale}`).removeClass("d-none"),o&&this.saveSelectedLanguage(o,this.selectedLocale)}saveSelectedLanguage(t,e){Lt.post({url:t,data:{language_iso_code:e}})}},{$:Et}=window;Et((()=>{const t=new g("attachment");t.addExtension(new C),t.addExtension(new O),t.addExtension(new x),t.addExtension(new j),t.addExtension(new M),t.addExtension(new gt),t.addExtension(new yt),t.addExtension(new Ct),new Ot}))})(),window.attachment=o})();