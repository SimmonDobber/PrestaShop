 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
class P{extend(t){const e=t.getContainer().find(w);new L(e).attach()}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$}=window,I=function(t,e){$.post(t).then((()=>window.location.assign(e)))},{$:z}=window;class R{extend(t){t.getContainer().on("click",_,(t=>{I(z(t.currentTarget).data("url"),z(t.currentTarget).data("redirect"))}))}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
class H{extend(t){t.getHeaderContainer().on("click",T,(()=>{window.location.reload()}))}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:Bt}=window;class St{extend(t){t.getContainer().on("click",s.submitAction,(e=>{this.submit(e,t)}))}submit(t,e){const n=Bt(t.currentTarget),o=n.data("confirm-message"),i=n.data("confirmTitle");void 0!==o&&o.length>0?void 0!==i?this.showConfirmModal(n,e,o,i):window.confirm(o)&&this.postForm(n,e):this.postForm(n,e)}showConfirmModal(t,e,n,o){const i=t.data("confirmButtonLabel"),r=t.data("closeButtonLabel"),s=t.data("confirmButtonClass");new jt({id:d(e.getId()),confirmTitle:o,confirmMessage:n,confirmButtonLabel:i,closeButtonLabel:r,confirmButtonClass:s},(()=>this.postForm(t,e))).show()}postForm(t,e){const n=Bt(j(e.getId()));n.attr("action",t.data("form-url")),n.attr("method",t.data("form-method")),n.submit()}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:Pt}=window;class $t{extend(t){t.getHeaderContainer().on("click",l.showQuery,(()=>this.onShowSqlQueryClick(t))),t.getHeaderContainer().on("click",l.exportQuery,(()=>this.onExportSqlManagerClick(t)))}onShowSqlQueryClick(t){const e=Pt(l.showModalForm(t.getId()));this.fillExportForm(e,t);const n=Pt(l.showModalGrid(t.getId()));n.modal("show"),n.on("click",A,(()=>e.submit()))}onExportSqlManagerClick(t){const e=Pt(l.showModalForm(t.getId()));this.fillExportForm(e,t),e.submit()}fillExportForm(t,e){const n=e.getContainer().find(c).data("query");t.find('textarea[name="sql"]').val(n),t.find('input[name="name"]').val(this.getNameFromBreadcrumb())}getNameFromBreadcrumb(){const t=Pt(y).find(D);let e="";return t.each(((t,n)=>{const o=Pt(n),i=o.find("a").length>0?o.find("a").text():o.text();e.length>0&&(e=e.concat(" > ")),e=e.concat(i)})),e}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
class It{extend(t){const e=t.getContainer().find(C);e.find(k).prop("disabled",!0),e.find(x).on("input dp.change",(()=>{e.find(k).prop("disabled",!1),e.find(O).prop("hidden",!1)}))}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:zt}=window;class Rt{extend(t){this.initRowLinks(t),this.initConfirmableActions(t)}initConfirmableActions(t){t.getContainer().on("click",a.linkRowAction,(t=>{const e=zt(t.currentTarget).data("confirm-message");e.length&&!window.confirm(e)&&t.preventDefault()}))}initRowLinks(t){zt("tr",t.getContainer()).each((function(){const t=zt(this);zt(a.linkRowActionClickableFirst,t).each((function(){const e=zt(this),n=e.closest("td"),o=zt(a.clickableTd,t).not(n);let i=!1;o.addClass("cursor-pointer").mousedown((()=>{zt(window).mousemove((()=>{i=!0,zt(window).unbind("mousemove")}))})),o.mouseup((()=>{const t=i;if(i=!1,zt(window).unbind("mousemove"),!t){const t=e.data("confirm-message");(!t.length||window.confirm(t)&&e.attr("href"))&&(document.location.href=e.attr("href"))}}))}))}))}}n(3867);
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:Ht}=window;class Ft{constructor(t){this.grid=t}extend(t){this.grid=t,this.addIdsToGridTableRows(),t.getContainer().find(c).tableDnD({onDragClass:E,dragHandle:h,onDrop:(t,e)=>this.handlePositionChange(e)}),t.getContainer().find(".js-drag-handle").hover((function(){Ht(this).closest("tr").addClass("hover")}),(function(){Ht(this).closest("tr").removeClass("hover")}))}handlePositionChange(t){const e=Ht(t).find(g(this.grid.getId())),n=e.data("update-url"),o=e.data("update-method"),i={positions:this.getRowsPositions()};this.updatePosition(n,i,o)}getRowsPositions(){const t=JSON.parse(Ht.tableDnD.jsonize())[`${this.grid.getId()}_grid_table`],e=[];let n;for(let o=0;o<t.length;o+=1)n=this.grid.getContainer().find(`#${t[o]}`),e.push({rowMarker:t[o],offset:n.data("dragAndDropOffset")});return this.computeMappingBetweenOldAndNewPositions(e)}addIdsToGridTableRows(){let t=0;this.grid.getContainer().find(p(this.grid.getId())).each(((e,n)=>{const o=Ht(n),i=`row_${o.data("id")}_${o.data("position")}`;o.closest("tr").attr("id",i),o.closest("td").addClass(u),o.closest("tr").data("dragAndDropOffset",t),t+=1}))}updatePosition(t,e,n){const o=["GET","POST"].includes(n),i=Ht("<form>",{action:t,method:o?n:"POST"}).appendTo("body"),r=e.positions.length;let s;for(let t=0;t<r;t+=1)s=e.positions[t],i.append(Ht("<input>",{type:"hidden",name:`positions[${t}][rowId]`,value:s.rowId}),Ht("<input>",{type:"hidden",name:`positions[${t}][oldPosition]`,value:s.oldPosition}),Ht("<input>",{type:"hidden",name:`positions[${t}][newPosition]`,value:s.newPosition}));o||i.append(Ht("<input>",{type:"hidden",name:"_method",value:n})),i.submit()}computeMappingBetweenOldAndNewPositions(t){var e;const n=/^row_(?<rowId>\d+)_(?<oldPosition>\d+)$/,o=[];for(let i=0;i<t.length;i+=1){const r=n.exec(t[i].rowMarker);if(r&&!K(r.groups)&&!K(r.groups.rowId)&&!K(r.groups.oldPosition)){const t=parseInt(null==(e=null==r?void 0:r.groups)?void 0:e.oldPosition,10);o[i]={rowId:r.groups.rowId,oldPosition:t,newPosition:t}}for(let e=0;e<t.length;e+=1)K(t[e])||K(t[e].offset)||K(o[t[e].offset])||K(o[e])||(o[t[e].offset].newPosition=o[e].oldPosition)}return o}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:Nt}=window;Nt((()=>{const t=new S("carrier");t.addExtension(new P),t.addExtension(new H),t.addExtension(new Ft(t)),t.addExtension(new It),t.addExtension(new R),t.addExtension(new $t),t.addExtension(new N),t.addExtension(new Rt),t.addExtension(new At),t.addExtension(new St),t.addExtension(new Lt);new e("carriersShowcaseCard").addExtension(new r)}))})(),window.carrier=o})();