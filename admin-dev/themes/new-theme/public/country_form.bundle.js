 ...
 * @copyright Since 2007 PrestaShop SA and Contributors
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */const f='input[name="country[need_zip_code]"]',h="#country_zip_code_format";
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
class p{constructor(){this.initZipCodeToggler()}initZipCodeToggler(){new d({disablingInputSelector:f,targetSelector:h,toggleType:c.availability})}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @copyright Since 2007 PrestaShop SA and Contributors
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */const v=".js-form-submit-btn",{$:g}=window;class m{constructor(){g(document).on("click",v,(e=>{e.preventDefault();const t=g(e.target);if(t.data("form-confirm-message")&&!1===window.confirm(t.data("form-confirm-message")))return;let n="POST",r=null;if(t.data("method")){const e=t.data("method"),o=["GET","POST"].includes(e);n=o?e:"POST",o||(r=g("<input>",{type:"_hidden",name:"_method",value:e}))}const o=g("<form>",{action:t.data("form-submit-url"),method:n});r&&o.append(r),t.data("form-csrf-token")&&o.append(g("<input>",{type:"_hidden",name:"_csrf_token",value:t.data("form-csrf-token")})),o.appendTo("body").submit()}))}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const y=new(n(7187).EventEmitter),{$:b}=window;const w=class{constructor(e={}){const t=e||{};this.localeItemSelector=t.localeItemSelector||".js-locale-item",this.localeButtonSelector=t.localeButtonSelector||".js-locale-btn",this.localeInputSelector=t.localeInputSelector||".js-locale-input",this.selectedLocale=b(this.localeItemSelector).data("locale"),b("body").on("click",this.localeItemSelector,this.toggleLanguage.bind(this)),y.on("languageSelected",this.toggleInputs.bind(this))}refreshInputs(e){this.selectedLocale&&y.emit("languageSelected",{selectedLocale:this.selectedLocale,form:e})}toggleLanguage(e){const t=b(e.target),n=t.closest("form");this.selectedLocale=t.data("locale"),this.refreshInputs(n)}toggleInputs(e){const{form:t}=e;this.selectedLocale=e.selectedLocale;const n=t.find(this.localeButtonSelector),r=n.data("change-language-url");n.text(this.selectedLocale),t.find(this.localeInputSelector).addClass("d-none"),t.find(`${this.localeInputSelector}.js-locale-${this.selectedLocale}`).removeClass("d-none"),r&&this.saveSelectedLanguage(r,this.selectedLocale)}saveSelectedLanguage(e,t){b.post({url:e,data:{language_iso_code:t}})}},{$:L}=window;L((()=>{new m,new w,new p}))})(),window.country_form=r})();