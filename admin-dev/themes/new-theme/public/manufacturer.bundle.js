 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:St}=window;class Lt{extend(t){this.initRowLinks(t),this.initConfirmableActions(t)}initConfirmableActions(t){t.getContainer().on("click",s.linkRowAction,(t=>{const e=St(t.currentTarget).data("confirm-message");e.length&&!window.confirm(e)&&t.preventDefault()}))}initRowLinks(t){St("tr",t.getContainer()).each((function(){const t=St(this);St(s.linkRowActionClickableFirst,t).each((function(){const e=St(this),n=e.closest("td"),o=St(s.clickableTd,t).not(n);let i=!1;o.addClass("cursor-pointer").mousedown((()=>{St(window).mousemove((()=>{i=!0,St(window).unbind("mousemove")}))})),o.mouseup((()=>{const t=i;if(i=!1,St(window).unbind("mousemove"),!t){const t=e.data("confirm-message");(!t.length||window.confirm(t)&&e.attr("href"))&&(document.location.href=e.attr("href"))}}))}))}))}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
