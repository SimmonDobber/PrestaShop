 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
class R{extend(t){const e=t.getContainer().find(p);new z(e).attach()}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:F}=window;class H{extend(t){this.initRowLinks(t),this.initConfirmableActions(t)}initConfirmableActions(t){t.getContainer().on("click",e.linkRowAction,(t=>{const e=F(t.currentTarget).data("confirm-message");e.length&&!window.confirm(e)&&t.preventDefault()}))}initRowLinks(t){F("tr",t.getContainer()).each((function(){const t=F(this);F(e.linkRowActionClickableFirst,t).each((function(){const n=F(this),o=n.closest("td"),i=F(e.clickableTd,t).not(o);let r=!1;i.addClass("cursor-pointer").mousedown((()=>{F(window).mousemove((()=>{r=!0,F(window).unbind("mousemove")}))})),i.mouseup((()=>{const t=r;if(r=!1,F(window).unbind("mousemove"),!t){const t=n.data("confirm-message");(!t.length||window.confirm(t)&&n.attr("href"))&&(document.location.href=n.attr("href"))}}))}))}))}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:N}=window;class q{extend(e){e.getHeaderContainer().on("click",t.gridSubmitAction,(t=>{this.handleSubmit(t,e)}))}handleSubmit(t,e){const n=N(t.currentTarget),o=n.data("confirm-message");if(void 0!==o&&o.length>0&&!window.confirm(o))return;const r=N(O(e.getId()));r.attr("action",n.data("url")),r.attr("method",n.data("method")),r.find(i.tokenInput(e.getId())).val(n.data("csrf")),r.submit()}}var G=n(9567),W=Object.defineProperty,V=Object.getOwnPropertySymbols,Y=Object.prototype.hasOwnProperty,Q=Object.prototype.propertyIsEnumerable,X=(t,e,n)=>e in t?W(t,e,{enumerable:!0,configurable:!0,writable:!0,value:n}):t[e]=n,U=(t,e)=>{for(var n in e||(e={}))Y.call(e,n)&&X(t,n,e[n]);if(V)for(var n of V(e))Q.call(e,n)&&X(t,n,e[n]);return t};
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
function Z(t){return void 0===t}var tt=Object.defineProperty,et=Object.getOwnPropertySymbols,nt=Object.prototype.hasOwnProperty,ot=Object.prototype.propertyIsEnumerable,it=(t,e,n)=>e in t?tt(t,e,{enumerable:!0,configurable:!0,writable:!0,value:n}):t[e]=n;
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:It}=window;class zt{constructor(){this.lockArray=[]}extend(e){e.getContainer().find(t.choiceOptions).find(b).on("click",(e=>{e.preventDefault();const n=It(e.currentTarget),o=n.closest(t.choiceOptions).data("url");this.submitForm(o,n)}))}submitForm(t,e){const n=e.data("value");if(this.isLocked(t))return;const o=It("<form>",{action:t,method:"POST"}).append(It("<input>",{name:"value",value:n,type:"hidden"}));o.appendTo("body"),o.submit(),this.lock(t)}isLocked(t){return this.lockArray.includes(t)}lock(t){this.lockArray.push(t)}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:Rt}=window;class Ft{extend(t){t.getContainer().find(p).find(m).on("click",(t=>{t.preventDefault(),this.toggleValue(Rt(t.delegateTarget))}))}toggleValue(t){const e=t.data("toggleUrl");this.submitAsForm(e)}submitAsForm(t){Rt("<form>",{action:t,method:"POST"}).appendTo("body").submit()}}n(3867);
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:Ht}=window;class Nt{constructor(t){this.grid=t}extend(t){this.grid=t,this.addIdsToGridTableRows(),t.getContainer().find(s).tableDnD({onDragClass:T,dragHandle:a,onDrop:(t,e)=>this.handlePositionChange(e)}),t.getContainer().find(".js-drag-handle").hover((function(){Ht(this).closest("tr").addClass("hover")}),(function(){Ht(this).closest("tr").removeClass("hover")}))}handlePositionChange(t){const e=Ht(t).find(f(this.grid.getId())),n=e.data("update-url"),o=e.data("update-method"),i={positions:this.getRowsPositions()};this.updatePosition(n,i,o)}getRowsPositions(){const t=JSON.parse(Ht.tableDnD.jsonize())[`${this.grid.getId()}_grid_table`],e=[];let n;for(let o=0;o<t.length;o+=1)n=this.grid.getContainer().find(`#${t[o]}`),e.push({rowMarker:t[o],offset:n.data("dragAndDropOffset")});return this.computeMappingBetweenOldAndNewPositions(e)}addIdsToGridTableRows(){let t=0;this.grid.getContainer().find(u(this.grid.getId())).each(((e,n)=>{const o=Ht(n),i=`row_${o.data("id")}_${o.data("position")}`;o.closest("tr").attr("id",i),o.closest("td").addClass(l),o.closest("tr").data("dragAndDropOffset",t),t+=1}))}updatePosition(t,e,n){const o=["GET","POST"].includes(n),i=Ht("<form>",{action:t,method:o?n:"POST"}).appendTo("body"),r=e.positions.length;let s;for(let t=0;t<r;t+=1)s=e.positions[t],i.append(Ht("<input>",{type:"hidden",name:`positions[${t}][rowId]`,value:s.rowId}),Ht("<input>",{type:"hidden",name:`positions[${t}][oldPosition]`,value:s.oldPosition}),Ht("<input>",{type:"hidden",name:`positions[${t}][newPosition]`,value:s.newPosition}));o||i.append(Ht("<input>",{type:"hidden",name:"_method",value:n})),i.submit()}computeMappingBetweenOldAndNewPositions(t){var e;const n=/^row_(?<rowId>\d+)_(?<oldPosition>\d+)$/,o=[];for(let i=0;i<t.length;i+=1){const r=n.exec(t[i].rowMarker);if(r&&!Z(r.groups)&&!Z(r.groups.rowId)&&!Z(r.groups.oldPosition)){const t=parseInt(null==(e=null==r?void 0:r.groups)?void 0:e.oldPosition,10);o[i]={rowId:r.groups.rowId,oldPosition:t,newPosition:t}}for(let e=0;e<t.length;e+=1)Z(t[e])||Z(t[e].offset)||Z(o[t[e].offset])||Z(o[e])||(o[t[e].offset].newPosition=o[e].oldPosition)}return o}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:qt}=window;qt((()=>{const t=new E("customer_thread");t.addExtension(new M),t.addExtension(new L),t.addExtension(new $),t.addExtension(new R),t.addExtension(new H),t.addExtension(new q),t.addExtension(new Bt),t.addExtension(new Pt),t.addExtension(new $t),t.addExtension(new Ft),t.addExtension(new Mt),t.addExtension(new zt),t.addExtension(new Nt(t))}))})(),window.customer_thread=o})();