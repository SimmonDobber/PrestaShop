 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:Tt}=window;class St{extend(t){this.initRowLinks(t),this.initConfirmableActions(t)}initConfirmableActions(t){t.getContainer().on("click",e.linkRowAction,(t=>{const e=Tt(t.currentTarget).data("confirm-message");e.length&&!window.confirm(e)&&t.preventDefault()}))}initRowLinks(t){Tt("tr",t.getContainer()).each((function(){const t=Tt(this);Tt(e.linkRowActionClickableFirst,t).each((function(){const n=Tt(this),o=n.closest("td"),i=Tt(e.clickableTd,t).not(o);let r=!1;i.addClass("cursor-pointer").mousedown((()=>{Tt(window).mousemove((()=>{r=!0,Tt(window).unbind("mousemove")}))})),i.mouseup((()=>{const t=r;if(r=!1,Tt(window).unbind("mousemove"),!t){const t=n.data("confirm-message");(!t.length||window.confirm(t)&&n.attr("href"))&&(document.location.href=n.attr("href"))}}))}))}))}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
