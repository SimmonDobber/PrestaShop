 ...
 */const e=e=>`#${e}_grid`,t=".js-grid-panel",o=".js-grid-header",i="table.table",s=".js-reset-search",l=".column-filters",a=".grid-search-button",c=".grid-reset-button",u="input:not(.js-bulk-action-select-all), select",{$:d}=window;class h{constructor(t){this.id=t,this.$container=d(e(this.id))}getId(){return this.id}getContainer(){return this.$container}getHeaderContainer(){return this.$container.closest(t).find(o)}addExtension(e){e.extend(this)}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
class L{extend(e){const t=e.getContainer().find(l);t.find(a).prop("disabled",!0),t.find(u).on("input dp.change",(()=>{t.find(a).prop("disabled",!1),t.find(c).prop("hidden",!1)}))}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
